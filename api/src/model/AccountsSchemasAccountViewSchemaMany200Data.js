...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.AccountsSchemasAccountViewSchemaMany200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.AccountsSchemasAccountViewSchemaMany200Licenses, root.S1MgmtApi.AccountsSchemasAccountViewSchemaMany200Skus);
  }
}(this, function(ApiClient, AccountsSchemasAccountViewSchemaMany200Licenses, AccountsSchemasAccountViewSchemaMany200Skus) {
  'use strict';

  /**
   * The AccountsSchemasAccountViewSchemaMany200Data model module.
   * @module model/AccountsSchemasAccountViewSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>AccountsSchemasAccountViewSchemaMany200Data</code>.
   * @alias module:model/AccountsSchemasAccountViewSchemaMany200Data
   * @class
   */
  ...
  /**
   * Constructs a <code>AccountsSchemasAccountViewSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountsSchemasAccountViewSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/AccountsSchemasAccountViewSchemaMany200Data} The populated <code>AccountsSchemasAccountViewSchemaMany200Data</code> instance.
   */
  ...
  /**
   * Account state
   * @member {module:model/AccountsSchemasAccountViewSchemaMany200Data.StateEnum} state
   */
  ...
  /**
   * Usage type
   * @member {module:model/AccountsSchemasAccountViewSchemaMany200Data.UsageTypeEnum} usageType
   */
  ...
  /**
   * Billing mode
   * @member {module:model/AccountsSchemasAccountViewSchemaMany200Data.BillingModeEnum} billingMode
   */
