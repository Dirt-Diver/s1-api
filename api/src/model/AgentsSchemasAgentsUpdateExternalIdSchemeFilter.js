...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.AgentsSchemasAgentsUpdateExternalIdSchemeFilter = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AgentsSchemasAgentsUpdateExternalIdSchemeFilter model module.
   * @module model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter
   * @version 2.1
   */

  /**
   * Constructs a new <code>AgentsSchemasAgentsUpdateExternalIdSchemeFilter</code>.
   * Applied filter - only matched Agents will be affected by the requested action.
   * @alias module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter
   * @class
   */
  ...
  /**
   * Constructs a <code>AgentsSchemasAgentsUpdateExternalIdSchemeFilter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter} obj Optional instance to populate.
   * @return {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter} The populated <code>AgentsSchemasAgentsUpdateExternalIdSchemeFilter</code> instance.
   */
   ...
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.MitigationModeSuspiciousEnum} mitigationModeSuspicious
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.AppsVulnerabilityStatusesNinEnum>} appsVulnerabilityStatusesNin
   */
  exports.prototype.appsVulnerabilityStatusesNin = undefined;

  /**
   * Not included scan statuses
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.ScanStatusesNinEnum>} scanStatusesNin
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.MachineTypesEnum>} machineTypes
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.MissingPermissionsNinEnum>} missingPermissionsNin
   */
  exports.prototype.missingPermissionsNin = undefined;

  /**
   * Migration status
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.MigrationStatusEnum} migrationStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.OsTypesNinEnum>} osTypesNin
   */
   ...
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.MitigationModeEnum} mitigationMode
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.UserActionsNeededNinEnum>} userActionsNeededNin
   */
  exports.prototype.userActionsNeededNin = undefined;

  /**
   * Status of Ranger
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.RangerStatusesEnum>} rangerStatuses
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.ConsoleMigrationStatusesNinEnum>} consoleMigrationStatusesNin
   */
   ...
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.RangerStatusEnum} rangerStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.ScanStatusesEnum>} scanStatuses
   */
  ...
  /**
   * Included OS types
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.OsTypesEnum>} osTypes
   */
  exports.prototype.osTypes = undefined;

  /**
   * Apps vulnerability status in
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.AppsVulnerabilityStatusesEnum>} appsVulnerabilityStatuses
   */
  ...
  /**
   * Scan status
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.ScanStatusEnum} scanStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.UserActionsNeededEnum>} userActionsNeeded
   */
  ...
  /**
   * OS architecture
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.OsArchEnum} osArch
   */
   ...
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.ThreatMitigationStatusEnum} threatMitigationStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.NetworkStatusesEnum>} networkStatuses
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.InstallerTypesEnum>} installerTypes
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.MissingPermissionsEnum>} missingPermissions
   */
  exports.prototype.missingPermissions = undefined;

  /**
   * Exclude Agents installed with these package types
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.InstallerTypesNinEnum>} installerTypesNin
   */
  exports.prototype.installerTypesNin = undefined;

  /**
   * Not included machine types
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.MachineTypesNinEnum>} machineTypesNin
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.RangerStatusesNinEnum>} rangerStatusesNin
   */
   ...
   * @member {module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.RsoLevelEnum} rsoLevel
   */
  ...
  /**
   * Migration status in
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.ConsoleMigrationStatusesEnum>} consoleMigrationStatuses
   */
  ...
  /**
   * Included network statuses
   * @member {Array.<module:model/AgentsSchemasAgentsUpdateExternalIdSchemeFilter.NetworkStatusesNinEnum>} networkStatusesNin
   */
