...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.V21DevicesSchemasDeviceDataSchema200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.V21DevicesSchemasDeviceDataSchemaMany200AlertCounts, root.S1MgmtApi.V21DevicesSchemasDeviceDataSchemaMany200ThreatCounts);
  }
  ...
  /**
   * The V21DevicesSchemasDeviceDataSchema200Data model module.
   * @module model/V21DevicesSchemasDeviceDataSchema200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>V21DevicesSchemasDeviceDataSchema200Data</code>.
   * Response data
   * @alias module:model/V21DevicesSchemasDeviceDataSchema200Data
   * @class
   ...
   * @param registrationType {module:model/V21DevicesSchemasDeviceDataSchema200Data.RegistrationTypeEnum} Registration type
  ...
  /**
   * Constructs a <code>V21DevicesSchemasDeviceDataSchema200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V21DevicesSchemasDeviceDataSchema200Data} obj Optional instance to populate.
   * @return {module:model/V21DevicesSchemasDeviceDataSchema200Data} The populated <code>V21DevicesSchemasDeviceDataSchema200Data</code> instance.
   */
  ...
  /**
   * ZipApp state
   * @member {module:model/V21DevicesSchemasDeviceDataSchema200Data.AppStateEnum} appState
   */
   ...
   * @member {module:model/V21DevicesSchemasDeviceDataSchema200Data.PrivilegesEnum} privileges
   */
   ...
   * @member {module:model/V21DevicesSchemasDeviceDataSchema200Data.HealthStateEnum} healthState
   */
   ...
   * @member {module:model/V21DevicesSchemasDeviceDataSchema200Data.ManagedStateEnum} managedState
   */
  exports.prototype.managedState = undefined;

  /**
   * Registration type
   * @member {module:model/V21DevicesSchemasDeviceDataSchema200Data.RegistrationTypeEnum} registrationType
   */
  ...
  /**
   * Device platform
   * @member {module:model/V21DevicesSchemasDeviceDataSchema200Data.PlatformEnum} platform
   */
