...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.DeviceControlSchemasPutDeviceSchemaData = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DeviceControlSchemasPutDeviceSchemaData model module.
   * @module model/DeviceControlSchemasPutDeviceSchemaData
   * @version 2.1
   */

  /**
   * Constructs a new <code>DeviceControlSchemasPutDeviceSchemaData</code>.
   * Data
   * @alias module:model/DeviceControlSchemasPutDeviceSchemaData
   * @class
   */
  ...
  /**
   * Constructs a <code>DeviceControlSchemasPutDeviceSchemaData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeviceControlSchemasPutDeviceSchemaData} obj Optional instance to populate.
   * @return {module:model/DeviceControlSchemasPutDeviceSchemaData} The populated <code>DeviceControlSchemasPutDeviceSchemaData</code> instance.
   */
   ...
   * @member {module:model/DeviceControlSchemasPutDeviceSchemaData.RuleTypeEnum} ruleType
   */
   ...
   * @member {module:model/DeviceControlSchemasPutDeviceSchemaData.ActionEnum} action
   */
  ...
  /**
   * Defines the Physical bus type of the Device.
   * @member {module:model/DeviceControlSchemasPutDeviceSchemaData.InterfaceEnum} _interface
   */
  exports.prototype._interface = undefined;

  /**
   * Defines if rule is Enabled or Disabled.
   * @member {module:model/DeviceControlSchemasPutDeviceSchemaData.StatusEnum} status
   */
  exports.prototype.status = undefined;

  /**
   * Access permission
   * @member {module:model/DeviceControlSchemasPutDeviceSchemaData.AccessPermissionEnum} accessPermission
   */
