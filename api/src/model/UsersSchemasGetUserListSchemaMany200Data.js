...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.UsersSchemasGetUserListSchemaMany200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.UsersSchemasUserSchema200DataApiToken, root.S1MgmtApi.UsersSchemasUserSchema200DataScopeRoles, root.S1MgmtApi.UsersSchemasUserSchema200DataSiteRoles);
  }
  ...
  /**
   * The UsersSchemasGetUserListSchemaMany200Data model module.
   * @module model/UsersSchemasGetUserListSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>UsersSchemasGetUserListSchemaMany200Data</code>.
   * @alias module:model/UsersSchemasGetUserListSchemaMany200Data
   * @class
   * @param scope {module:model/UsersSchemasGetUserListSchemaMany200Data.ScopeEnum} User Scope
   */
  ...
  /**
   * Constructs a <code>UsersSchemasGetUserListSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersSchemasGetUserListSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/UsersSchemasGetUserListSchemaMany200Data} The populated <code>UsersSchemasGetUserListSchemaMany200Data</code> instance.
   */
  ...
  /**
   * User Scope
   * @member {module:model/UsersSchemasGetUserListSchemaMany200Data.ScopeEnum} scope
   */
