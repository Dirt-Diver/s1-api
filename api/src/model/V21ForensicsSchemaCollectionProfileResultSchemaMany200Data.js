...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.V21ForensicsSchemaCollectionProfileResultSchemaMany200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.V21ForensicsSchemaCollectionProfileResultSchema200DataArtifacts);
  }
}(this, function(ApiClient, V21ForensicsSchemaCollectionProfileResultSchema200DataArtifacts) {
  'use strict';

  /**
   * The V21ForensicsSchemaCollectionProfileResultSchemaMany200Data model module.
   * @module model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>V21ForensicsSchemaCollectionProfileResultSchemaMany200Data</code>.
   * @alias module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data
   * @class
   * @param isBundled {Boolean} Flag indicating if the Collection profile is bundled (provided by S1)
   * @param scopeLevel {module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data.ScopeLevelEnum} Scope level where the Collection profile is stored
   * @param osTypes {Array.<module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data.OsTypesEnum>} Os types
   ...
   * @param type {module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data.TypeEnum} Type of RemoteOps Action (forensicsProfile)
  ...
  /**
   * Constructs a <code>V21ForensicsSchemaCollectionProfileResultSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data} The populated <code>V21ForensicsSchemaCollectionProfileResultSchemaMany200Data</code> instance.
   */
   ...
   * @member {module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data.ScopeLevelEnum} scopeLevel
   */
  ...
  /**
   * Os types
   * @member {Array.<module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data.OsTypesEnum>} osTypes
   */
   ...
   * @member {module:model/V21ForensicsSchemaCollectionProfileResultSchemaMany200Data.TypeEnum} type
   */
