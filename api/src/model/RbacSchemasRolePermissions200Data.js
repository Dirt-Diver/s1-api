...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.RbacSchemasRolePermissions200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.RbacSchemasRolePermissions200DataPages);
  }
}(this, function(ApiClient, RbacSchemasRolePermissions200DataPages) {
  'use strict';

  /**
   * The RbacSchemasRolePermissions200Data model module.
   * @module model/RbacSchemasRolePermissions200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>RbacSchemasRolePermissions200Data</code>.
   * Response data
   * @alias module:model/RbacSchemasRolePermissions200Data
   * @class
   */
  ...
  /**
   * Constructs a <code>RbacSchemasRolePermissions200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RbacSchemasRolePermissions200Data} obj Optional instance to populate.
   * @return {module:model/RbacSchemasRolePermissions200Data} The populated <code>RbacSchemasRolePermissions200Data</code> instance.
   */
