...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Statuses);
  }
  ...
  /**
   * The V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data model module.
   * @module model/V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data</code>.
   * @alias module:model/V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data
   * @class
   */
  ...
  /**
   * Constructs a <code>V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data} The populated <code>V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data</code> instance.
   */
   ...
   * @member {module:model/V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data.ExploitedInTheWildEnum} exploitedInTheWild
   */
  ...
  /**
   * Remediation level
   * @member {module:model/V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data.RemediationLevelEnum} remediationLevel
   */
   ...
   */
  exports.prototype.versionCount = undefined;

  /**
   * Exploit code maturity
   * @member {module:model/V21ApplicationManagementApplicationManagementSchemasRisksByAggregatedApplicationsSchemaMany200Data.ExploitCodeMaturityEnum} exploitCodeMaturity
   */
