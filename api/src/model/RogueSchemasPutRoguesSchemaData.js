...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.RogueSchemasPutRoguesSchemaData = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.SchemasRangerSettingsSchema200DataRestrictions, root.S1MgmtApi.SchemasRangerSettingsSchema200DataSpecificPorts);
  }
}(this, function(ApiClient, SchemasRangerSettingsSchema200DataRestrictions, SchemasRangerSettingsSchema200DataSpecificPorts) {
  'use strict';

  /**
   * The RogueSchemasPutRoguesSchemaData model module.
   * @module model/RogueSchemasPutRoguesSchemaData
   * @version 2.1
   */

  /**
   * Constructs a new <code>RogueSchemasPutRoguesSchemaData</code>.
   * Data
   * @alias module:model/RogueSchemasPutRoguesSchemaData
   * @class
   */
  ...
  /**
   * Constructs a <code>RogueSchemasPutRoguesSchemaData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RogueSchemasPutRoguesSchemaData} obj Optional instance to populate.
   * @return {module:model/RogueSchemasPutRoguesSchemaData} The populated <code>RogueSchemasPutRoguesSchemaData</code> instance.
   */
