...
(function(root, factory) {
  ...
  /**
   * The LocationsSchemasLocationViewSchemaMany200Data model module.
   * @module model/LocationsSchemasLocationViewSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>LocationsSchemasLocationViewSchemaMany200Data</code>.
   * @alias module:model/LocationsSchemasLocationViewSchemaMany200Data
   * @class
   * @param operator {module:model/LocationsSchemasLocationViewSchemaMany200Data.OperatorEnum} Logical operator to apply between the set of identifiers
  ...
  /**
   * Constructs a <code>LocationsSchemasLocationViewSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LocationsSchemasLocationViewSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/LocationsSchemasLocationViewSchemaMany200Data} The populated <code>LocationsSchemasLocationViewSchemaMany200Data</code> instance.
   */
   ...
   * @member {module:model/LocationsSchemasLocationViewSchemaMany200Data.OperatorEnum} operator
   */
  ...
  /**
   * Scope
   * @member {module:model/LocationsSchemasLocationViewSchemaMany200Data.ScopeEnum} scope
   */
