...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.AgentsSchemasAgentsDangerousActionSchemaFilter = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AgentsSchemasAgentsDangerousActionSchemaFilter model module.
   * @module model/AgentsSchemasAgentsDangerousActionSchemaFilter
   * @version 2.1
   */

  /**
   * Constructs a new <code>AgentsSchemasAgentsDangerousActionSchemaFilter</code>.
   * Applied filter - only matched Agents will be affected by the requested action. Note: One of these filter arguments must be supplied: ids, groupIds, filterId.
   * @alias module:model/AgentsSchemasAgentsDangerousActionSchemaFilter
   * @class
   */
  ...
  /**
   * Constructs a <code>AgentsSchemasAgentsDangerousActionSchemaFilter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter} obj Optional instance to populate.
   * @return {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter} The populated <code>AgentsSchemasAgentsDangerousActionSchemaFilter</code> instance.
   */
   ...
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.MitigationModeSuspiciousEnum} mitigationModeSuspicious
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.AppsVulnerabilityStatusesNinEnum>} appsVulnerabilityStatusesNin
   */
  exports.prototype.appsVulnerabilityStatusesNin = undefined;

  /**
   * Not included scan statuses
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.ScanStatusesNinEnum>} scanStatusesNin
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.MachineTypesEnum>} machineTypes
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.MissingPermissionsNinEnum>} missingPermissionsNin
   */
  exports.prototype.missingPermissionsNin = undefined;

  /**
   * Migration status
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.MigrationStatusEnum} migrationStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.OsTypesNinEnum>} osTypesNin
   */
   ...
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.MitigationModeEnum} mitigationMode
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.UserActionsNeededNinEnum>} userActionsNeededNin
   */
  exports.prototype.userActionsNeededNin = undefined;

  /**
   * Status of Ranger
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.RangerStatusesEnum>} rangerStatuses
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.ConsoleMigrationStatusesNinEnum>} consoleMigrationStatusesNin
   */
   ...
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.RangerStatusEnum} rangerStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.ScanStatusesEnum>} scanStatuses
   */
  ...
  /**
   * Included OS types
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.OsTypesEnum>} osTypes
   */
  exports.prototype.osTypes = undefined;

  /**
   * Apps vulnerability status in
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.AppsVulnerabilityStatusesEnum>} appsVulnerabilityStatuses
   */
  ...
  /**
   * Scan status
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.ScanStatusEnum} scanStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.UserActionsNeededEnum>} userActionsNeeded
   */
  ...
  /**
   * OS architecture
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.OsArchEnum} osArch
   */
   ...
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.ThreatMitigationStatusEnum} threatMitigationStatus
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.NetworkStatusesEnum>} networkStatuses
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.InstallerTypesEnum>} installerTypes
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.MissingPermissionsEnum>} missingPermissions
   */
  exports.prototype.missingPermissions = undefined;

  /**
   * Exclude Agents installed with these package types
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.InstallerTypesNinEnum>} installerTypesNin
   */
  exports.prototype.installerTypesNin = undefined;

  /**
   * Not included machine types
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.MachineTypesNinEnum>} machineTypesNin
   */
   ...
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.RangerStatusesNinEnum>} rangerStatusesNin
   */
   ...
   * @member {module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.RsoLevelEnum} rsoLevel
   */
  ...
  /**
   * Migration status in
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.ConsoleMigrationStatusesEnum>} consoleMigrationStatuses
   */
  ...
  /**
   * Included network statuses
   * @member {Array.<module:model/AgentsSchemasAgentsDangerousActionSchemaFilter.NetworkStatusesNinEnum>} networkStatusesNin
   */
