...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.V21SchemasGetIndicatorSchemaMany200Data = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The V21SchemasGetIndicatorSchemaMany200Data model module.
   * @module model/V21SchemasGetIndicatorSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>V21SchemasGetIndicatorSchemaMany200Data</code>.
   * @alias module:model/V21SchemasGetIndicatorSchemaMany200Data
   * @class
   * @param source {String} The source of the identified Threat Intelligence indicator
   * @param type {module:model/V21SchemasGetIndicatorSchemaMany200Data.TypeEnum} The type of the Threat Intelligence indicator
  ...
  /**
   * Constructs a <code>V21SchemasGetIndicatorSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V21SchemasGetIndicatorSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/V21SchemasGetIndicatorSchemaMany200Data} The populated <code>V21SchemasGetIndicatorSchemaMany200Data</code> instance.
   */
   ...
   * @member {module:model/V21SchemasGetIndicatorSchemaMany200Data.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * The comparison method used by SentinelOne to trigger the event
   * @member {module:model/V21SchemasGetIndicatorSchemaMany200Data.MethodEnum} method
   */
  ...
  /**
   * Scope of the ioc
   * @member {module:model/V21SchemasGetIndicatorSchemaMany200Data.ScopeEnum} scope
   */
