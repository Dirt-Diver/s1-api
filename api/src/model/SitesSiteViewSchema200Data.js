...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.SitesSiteViewSchema200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.SitesSiteResponseSchema200DataLicenses);
  }
}(this, function(ApiClient, SitesSiteResponseSchema200DataLicenses) {
  'use strict';

  /**
   * The SitesSiteViewSchema200Data model module.
   * @module model/SitesSiteViewSchema200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>SitesSiteViewSchema200Data</code>.
   * Response data
   * @alias module:model/SitesSiteViewSchema200Data
   * @class
   */
  ...
  /**
   * Constructs a <code>SitesSiteViewSchema200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SitesSiteViewSchema200Data} obj Optional instance to populate.
   * @return {module:model/SitesSiteViewSchema200Data} The populated <code>SitesSiteViewSchema200Data</code> instance.
   */
  ...
  /**
   * Site state
   * @member {module:model/SitesSiteViewSchema200Data.StateEnum} state
   */
   ...
   * @member {module:model/SitesSiteViewSchema200Data.SuiteEnum} suite
   */
   ...
   * @member {module:model/SitesSiteViewSchema200Data.SkuEnum} sku
   */
