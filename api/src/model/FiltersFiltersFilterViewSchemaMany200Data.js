...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.FiltersFiltersFilterViewSchemaMany200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.FiltersFiltersFilterViewSchemaMany200FilterFields);
  }
}(this, function(ApiClient, FiltersFiltersFilterViewSchemaMany200FilterFields) {
  'use strict';

  /**
   * The FiltersFiltersFilterViewSchemaMany200Data model module.
   * @module model/FiltersFiltersFilterViewSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>FiltersFiltersFilterViewSchemaMany200Data</code>.
   * @alias module:model/FiltersFiltersFilterViewSchemaMany200Data
   * @class
   * @param id {String} Id
   * @param createdAt {Date} Created at
   * @param name {String} Name
   * @param updatedAt {Date} Updated at
   * @param scopeLevel {module:model/FiltersFiltersFilterViewSchemaMany200Data.ScopeLevelEnum} Filter scope
   */
  ...
  /**
   * Constructs a <code>FiltersFiltersFilterViewSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FiltersFiltersFilterViewSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/FiltersFiltersFilterViewSchemaMany200Data} The populated <code>FiltersFiltersFilterViewSchemaMany200Data</code> instance.
   */
  ...
  /**
   * Filter scope
   * @member {module:model/FiltersFiltersFilterViewSchemaMany200Data.ScopeLevelEnum} scopeLevel
   */
