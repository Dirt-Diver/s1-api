...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.V21MarketplaceSchemaApplicationConfigResponseSchema200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.V21MarketplaceSchemaApplicationCatalogConfigResponseSchema200DataFields);
  }
}(this, function(ApiClient, V21MarketplaceSchemaApplicationCatalogConfigResponseSchema200DataFields) {
  'use strict';

  /**
   * The V21MarketplaceSchemaApplicationConfigResponseSchema200Data model module.
   * @module model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>V21MarketplaceSchemaApplicationConfigResponseSchema200Data</code>.
   * Response data
   * @alias module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data
   * @class
   * @param desiredStatus {module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data.DesiredStatusEnum} Desired status
   * @param status {module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data.StatusEnum} Status
   */
  ...
  /**
   * Constructs a <code>V21MarketplaceSchemaApplicationConfigResponseSchema200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data} obj Optional instance to populate.
   * @return {module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data} The populated <code>V21MarketplaceSchemaApplicationConfigResponseSchema200Data</code> instance.
   */
   ...
   * @member {module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data.ScopeLevelEnum} scopeLevel
   */
  ...
  /**
   * Desired status
   * @member {module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data.DesiredStatusEnum} desiredStatus
   */
  ...
  /**
   * Status
   * @member {module:model/V21MarketplaceSchemaApplicationConfigResponseSchema200Data.StatusEnum} status
   */
