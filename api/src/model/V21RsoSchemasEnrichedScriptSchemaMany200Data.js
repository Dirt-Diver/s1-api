...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.V21RsoSchemasEnrichedScriptSchemaMany200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.V21RsoSchemasEnrichedScriptSchemaMany200Package);
  }
}(this, function(ApiClient, V21RsoSchemasEnrichedScriptSchemaMany200Package) {
  'use strict';

  /**
   * The V21RsoSchemasEnrichedScriptSchemaMany200Data model module.
   * @module model/V21RsoSchemasEnrichedScriptSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>V21RsoSchemasEnrichedScriptSchemaMany200Data</code>.
   * @alias module:model/V21RsoSchemasEnrichedScriptSchemaMany200Data
   * @class
  ...
  /**
   * Constructs a <code>V21RsoSchemasEnrichedScriptSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V21RsoSchemasEnrichedScriptSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/V21RsoSchemasEnrichedScriptSchemaMany200Data} The populated <code>V21RsoSchemasEnrichedScriptSchemaMany200Data</code> instance.
   */
  ...
  /**
   * Scope level
   * @member {module:model/V21RsoSchemasEnrichedScriptSchemaMany200Data.ScopeLevelEnum} scopeLevel
   */
