...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.SitesSiteResponseSchema200DataSites = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.SitesSiteResponseSchema200DataLicenses);
  }
}(this, function(ApiClient, SitesSiteResponseSchema200DataLicenses) {
  'use strict';

  /**
   * The SitesSiteResponseSchema200DataSites model module.
   * @module model/SitesSiteResponseSchema200DataSites
   * @version 2.1
   */

  /**
   * Constructs a new <code>SitesSiteResponseSchema200DataSites</code>.
   * @alias module:model/SitesSiteResponseSchema200DataSites
   * @class
   */
  ...
  /**
   * Constructs a <code>SitesSiteResponseSchema200DataSites</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SitesSiteResponseSchema200DataSites} obj Optional instance to populate.
   * @return {module:model/SitesSiteResponseSchema200DataSites} The populated <code>SitesSiteResponseSchema200DataSites</code> instance.
   */
  ...
  /**
   * Site state
   * @member {module:model/SitesSiteResponseSchema200DataSites.StateEnum} state
   */
   ...
   * @member {module:model/SitesSiteResponseSchema200DataSites.SuiteEnum} suite
   */
   ...
   * @member {module:model/SitesSiteResponseSchema200DataSites.SkuEnum} sku
   */
