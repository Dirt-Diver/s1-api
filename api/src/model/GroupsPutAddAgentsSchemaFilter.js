...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.GroupsPutAddAgentsSchemaFilter = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The GroupsPutAddAgentsSchemaFilter model module.
   * @module model/GroupsPutAddAgentsSchemaFilter
   * @version 2.1
   */

  /**
   * Constructs a new <code>GroupsPutAddAgentsSchemaFilter</code>.
   * Specification of which agents should be moved
   * @alias module:model/GroupsPutAddAgentsSchemaFilter
   * @class
   */
  ...
  /**
   * Constructs a <code>GroupsPutAddAgentsSchemaFilter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupsPutAddAgentsSchemaFilter} obj Optional instance to populate.
   * @return {module:model/GroupsPutAddAgentsSchemaFilter} The populated <code>GroupsPutAddAgentsSchemaFilter</code> instance.
   */
   ...
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.MitigationModeSuspiciousEnum} mitigationModeSuspicious
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.AppsVulnerabilityStatusesNinEnum>} appsVulnerabilityStatusesNin
   */
  exports.prototype.appsVulnerabilityStatusesNin = undefined;

  /**
   * Not included scan statuses
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.ScanStatusesNinEnum>} scanStatusesNin
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.MachineTypesEnum>} machineTypes
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.MissingPermissionsNinEnum>} missingPermissionsNin
   */
  exports.prototype.missingPermissionsNin = undefined;

  /**
   * Migration status
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.MigrationStatusEnum} migrationStatus
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.OsTypesNinEnum>} osTypesNin
   */
   ...
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.MitigationModeEnum} mitigationMode
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.UserActionsNeededNinEnum>} userActionsNeededNin
   */
  exports.prototype.userActionsNeededNin = undefined;

  /**
   * Status of Ranger
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.RangerStatusesEnum>} rangerStatuses
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.ConsoleMigrationStatusesNinEnum>} consoleMigrationStatusesNin
   */
   ...
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.RangerStatusEnum} rangerStatus
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.ScanStatusesEnum>} scanStatuses
   */
  ...
  /**
   * Included OS types
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.OsTypesEnum>} osTypes
   */
  exports.prototype.osTypes = undefined;

  /**
   * Apps vulnerability status in
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.AppsVulnerabilityStatusesEnum>} appsVulnerabilityStatuses
   */
  ...
  /**
   * (DEPRECATED; use 'ids' instead) List of agent ids to move to a new group
  ...
  /**
   * Scan status
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.ScanStatusEnum} scanStatus
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.UserActionsNeededEnum>} userActionsNeeded
   */
  ...
  /**
   * OS architecture
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.OsArchEnum} osArch
   */
   ...
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.ThreatMitigationStatusEnum} threatMitigationStatus
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.NetworkStatusesEnum>} networkStatuses
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.InstallerTypesEnum>} installerTypes
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.MissingPermissionsEnum>} missingPermissions
   */
  exports.prototype.missingPermissions = undefined;

  /**
   * Exclude Agents installed with these package types
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.InstallerTypesNinEnum>} installerTypesNin
   */
  exports.prototype.installerTypesNin = undefined;

  /**
   * Not included machine types
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.MachineTypesNinEnum>} machineTypesNin
   */
   ...
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.RangerStatusesNinEnum>} rangerStatusesNin
   */
   ...
   * @member {module:model/GroupsPutAddAgentsSchemaFilter.RsoLevelEnum} rsoLevel
   */
  ...
  /**
   * Migration status in
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.ConsoleMigrationStatusesEnum>} consoleMigrationStatuses
   */
  ...
  /**
   * Included network statuses
   * @member {Array.<module:model/GroupsPutAddAgentsSchemaFilter.NetworkStatusesNinEnum>} networkStatusesNin
   */
