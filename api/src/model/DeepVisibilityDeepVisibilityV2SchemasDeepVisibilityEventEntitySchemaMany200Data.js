...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data model module.
   * @module model/DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data</code>.
   * @alias module:model/DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data
   * @class
   ...
   * @param agentOs {module:model/DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data.AgentOsEnum} OS type
   ...
   */
  var exports = function(objectType, agentIsActive, agentVersion, agentInfected, user, agentOs, agentIsDecommissioned, siteName, processName, agentUuid, agentId, agentName, agentDomain, agentMachineType, agentNetworkStatus, id, agentGroupId, agentIp, createdAt) {
  ...
  /**
   * Constructs a <code>DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data} The populated <code>DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('srcProcDownloadToken'))
        obj.srcProcDownloadToken = ApiClient.convertToType(data['srcProcDownloadToken'], 'String');
      if (data.hasOwnProperty('parentProcessStartTime'))
        obj.parentProcessStartTime = ApiClient.convertToType(data['parentProcessStartTime'], 'String');
      ...
      if (data.hasOwnProperty('isAgentVersionFullySupportedForPgMessage'))
        obj.isAgentVersionFullySupportedForPgMessage = ApiClient.convertToType(data['isAgentVersionFullySupportedForPgMessage'], 'String');
      ...
      if (data.hasOwnProperty('forensicUrl'))
        obj.forensicUrl = ApiClient.convertToType(data['forensicUrl'], 'String');
      ...
      if (data.hasOwnProperty('isAgentVersionFullySupportedForPg'))
        obj.isAgentVersionFullySupportedForPg = ApiClient.convertToType(data['isAgentVersionFullySupportedForPg'], 'Boolean');
      ...
      if (data.hasOwnProperty('processStartTime'))
        obj.processStartTime = ApiClient.convertToType(data['processStartTime'], 'String');
      ...
      if (data.hasOwnProperty('relatedToThreat'))
        obj.relatedToThreat = ApiClient.convertToType(data['relatedToThreat'], 'String');
   ...
   * @member {String} srcProcDownloadToken
   */
  exports.prototype.srcProcDownloadToken = undefined;

  /**
   * Parent process start time
   * @member {String} parentProcessStartTime
   */
  exports.prototype.parentProcessStartTime = undefined;
   ...
   * @member {String} isAgentVersionFullySupportedForPgMessage
   */
  exports.prototype.isAgentVersionFullySupportedForPgMessage = undefined;
  ...
  /**
   * OS type
   * @member {module:model/DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityEventEntitySchemaMany200Data.AgentOsEnum} agentOs
   */
  ...
  /**
   * Forensic url
   * @member {String} forensicUrl
   */
  exports.prototype.forensicUrl = undefined;
   ...
   * @member {Boolean} isAgentVersionFullySupportedForPg
   */
  exports.prototype.isAgentVersionFullySupportedForPg = undefined;
  ...
  /**
   * Process start time
   * @member {String} processStartTime
   */
