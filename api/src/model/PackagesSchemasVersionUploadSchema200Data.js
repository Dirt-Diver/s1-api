...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.PackagesSchemasVersionUploadSchema200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.PackagesSchemasLatestPackagesSchema200DataOsTypesSites);
  }
}(this, function(ApiClient, PackagesSchemasLatestPackagesSchema200DataOsTypesSites) {
  'use strict';

  /**
   * The PackagesSchemasVersionUploadSchema200Data model module.
   * @module model/PackagesSchemasVersionUploadSchema200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>PackagesSchemasVersionUploadSchema200Data</code>.
   * Response data
   * @alias module:model/PackagesSchemasVersionUploadSchema200Data
   * @class
   ...
   * @param status {module:model/PackagesSchemasVersionUploadSchema200Data.StatusEnum} Status
   */
  ...
  /**
   * Constructs a <code>PackagesSchemasVersionUploadSchema200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PackagesSchemasVersionUploadSchema200Data} obj Optional instance to populate.
   * @return {module:model/PackagesSchemasVersionUploadSchema200Data} The populated <code>PackagesSchemasVersionUploadSchema200Data</code> instance.
   */
  ...
  /**
   * Platform type
   * @member {module:model/PackagesSchemasVersionUploadSchema200Data.PlatformTypeEnum} platformType
   */
  ...
  /**
   * File extension
   * @member {module:model/PackagesSchemasVersionUploadSchema200Data.FileExtensionEnum} fileExtension
   */
   ...
   * @member {module:model/PackagesSchemasVersionUploadSchema200Data.OsArchEnum} osArch
   */
  ...
  /**
   * Package type
   * @member {module:model/PackagesSchemasVersionUploadSchema200Data.PackageTypeEnum} packageType
   */
  ...
  /**
   * Platform type
   * @member {module:model/PackagesSchemasVersionUploadSchema200Data.OsTypeEnum} osType
   */
  ...
  /**
   * Status
   * @member {module:model/PackagesSchemasVersionUploadSchema200Data.StatusEnum} status
   */
   ...
   * @member {module:model/PackagesSchemasVersionUploadSchema200Data.ScopeLevelEnum} scopeLevel
   */
