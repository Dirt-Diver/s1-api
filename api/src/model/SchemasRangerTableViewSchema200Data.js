...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.SchemasRangerTableViewSchema200Data = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.SchemasRangerTableViewSchemaMany200DeviceReviewLog, root.S1MgmtApi.SchemasRangerTableViewSchemaMany200Networks, root.S1MgmtApi.SchemasRangerTableViewSchemaMany200Tags);
  }
  ...
  /**
   * The SchemasRangerTableViewSchema200Data model module.
   * @module model/SchemasRangerTableViewSchema200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>SchemasRangerTableViewSchema200Data</code>.
   * Response data
   * @alias module:model/SchemasRangerTableViewSchema200Data
   * @class
   */
  ...
  /**
   * Constructs a <code>SchemasRangerTableViewSchema200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SchemasRangerTableViewSchema200Data} obj Optional instance to populate.
   * @return {module:model/SchemasRangerTableViewSchema200Data} The populated <code>SchemasRangerTableViewSchema200Data</code> instance.
   */
