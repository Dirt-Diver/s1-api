...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.FiltersFiltersNewFilterSchemaDataFilterFields = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The FiltersFiltersNewFilterSchemaDataFilterFields model module.
   * @module model/FiltersFiltersNewFilterSchemaDataFilterFields
   * @version 2.1
   */

  /**
   * Constructs a new <code>FiltersFiltersNewFilterSchemaDataFilterFields</code>.
   * A set of parameters to filter by
   * @alias module:model/FiltersFiltersNewFilterSchemaDataFilterFields
   * @class
   */
  ...
  /**
   * Constructs a <code>FiltersFiltersNewFilterSchemaDataFilterFields</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FiltersFiltersNewFilterSchemaDataFilterFields} obj Optional instance to populate.
   * @return {module:model/FiltersFiltersNewFilterSchemaDataFilterFields} The populated <code>FiltersFiltersNewFilterSchemaDataFilterFields</code> instance.
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.AppsVulnerabilityStatusesNinEnum>} appsVulnerabilityStatusesNin
   */
  exports.prototype.appsVulnerabilityStatusesNin = undefined;

  /**
   * Not included scan statuses
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.ScanStatusesNinEnum>} scanStatusesNin
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.MachineTypesEnum>} machineTypes
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.MissingPermissionsNinEnum>} missingPermissionsNin
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.OsTypesNinEnum>} osTypesNin
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.UserActionsNeededNinEnum>} userActionsNeededNin
   */
  exports.prototype.userActionsNeededNin = undefined;

  /**
   * Status of Ranger
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.RangerStatusesEnum>} rangerStatuses
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.ConsoleMigrationStatusesNinEnum>} consoleMigrationStatusesNin
   */
   ...
   * @member {module:model/FiltersFiltersNewFilterSchemaDataFilterFields.RangerStatusEnum} rangerStatus
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.ScanStatusesEnum>} scanStatuses
   */
  ...
  /**
   * Included OS types
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.OsTypesEnum>} osTypes
   */
  exports.prototype.osTypes = undefined;

  /**
   * Apps vulnerability status in
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.AppsVulnerabilityStatusesEnum>} appsVulnerabilityStatuses
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.UserActionsNeededEnum>} userActionsNeeded
   */
  exports.prototype.userActionsNeeded = undefined;

  /**
   * OS architecture
   * @member {module:model/FiltersFiltersNewFilterSchemaDataFilterFields.OsArchEnum} osArch
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.NetworkStatusesEnum>} networkStatuses
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.InstallerTypesEnum>} installerTypes
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.MissingPermissionsEnum>} missingPermissions
   */
  exports.prototype.missingPermissions = undefined;

  /**
   * Exclude Agents installed with these package types
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.InstallerTypesNinEnum>} installerTypesNin
   */
  exports.prototype.installerTypesNin = undefined;

  /**
   * Not included machine types
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.MachineTypesNinEnum>} machineTypesNin
   */
   ...
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.RangerStatusesNinEnum>} rangerStatusesNin
   */
  ...
  /**
   * Migration status in
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.ConsoleMigrationStatusesEnum>} consoleMigrationStatuses
   */
  ...
  /**
   * Included network statuses
   * @member {Array.<module:model/FiltersFiltersNewFilterSchemaDataFilterFields.NetworkStatusesNinEnum>} networkStatusesNin
   */
