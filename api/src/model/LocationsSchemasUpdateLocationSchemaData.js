...
(function(root, factory) {
  ...
  /**
   * The LocationsSchemasUpdateLocationSchemaData model module.
   * @module model/LocationsSchemasUpdateLocationSchemaData
   * @version 2.1
   */

  /**
   * Constructs a new <code>LocationsSchemasUpdateLocationSchemaData</code>.
   * Data
   * @alias module:model/LocationsSchemasUpdateLocationSchemaData
   * @class
  ...
  /**
   * Constructs a <code>LocationsSchemasUpdateLocationSchemaData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LocationsSchemasUpdateLocationSchemaData} obj Optional instance to populate.
   * @return {module:model/LocationsSchemasUpdateLocationSchemaData} The populated <code>LocationsSchemasUpdateLocationSchemaData</code> instance.
   */
   ...
   * @member {module:model/LocationsSchemasUpdateLocationSchemaData.OperatorEnum} operator
   */
