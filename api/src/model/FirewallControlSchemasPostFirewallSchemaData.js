...
(function(root, factory) {
  ...
  /**
   * The FirewallControlSchemasPostFirewallSchemaData model module.
   * @module model/FirewallControlSchemasPostFirewallSchemaData
   * @version 2.1
   */

  /**
   * Constructs a new <code>FirewallControlSchemasPostFirewallSchemaData</code>.
   * Data
   * @alias module:model/FirewallControlSchemasPostFirewallSchemaData
   * @class
   * @param action {module:model/FirewallControlSchemasPostFirewallSchemaData.ActionEnum} Defines if agent shall Block or Allow use of firewalls which matches the rule parameters.
   * @param name {String} The name of the firewall rule.
   * @param status {module:model/FirewallControlSchemasPostFirewallSchemaData.StatusEnum} Defines if rule is Enabled or Disabled
   */
  var exports = function(action, name, status) {
    this.action = action;
    this.name = name;
    this.status = status;
  };
  ...
  /**
   * Constructs a <code>FirewallControlSchemasPostFirewallSchemaData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FirewallControlSchemasPostFirewallSchemaData} obj Optional instance to populate.
   * @return {module:model/FirewallControlSchemasPostFirewallSchemaData} The populated <code>FirewallControlSchemasPostFirewallSchemaData</code> instance.
   */
   ...
   * @member {module:model/FirewallControlSchemasPostFirewallSchemaData.ActionEnum} action
   */
   ...
   * @member {module:model/FirewallControlSchemasPostFirewallSchemaData.OsTypeEnum} osType
   */
  ...
  /**
   * Os types
   * @member {Array.<module:model/FirewallControlSchemasPostFirewallSchemaData.OsTypesEnum>} osTypes
   */
   ...
   * @member {module:model/FirewallControlSchemasPostFirewallSchemaData.DirectionEnum} direction
   */
  exports.prototype.direction = undefined;

  /**
   * Defines if rule is Enabled or Disabled
   * @member {module:model/FirewallControlSchemasPostFirewallSchemaData.StatusEnum} status
   */
