...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.SettingsSyslogSettingsPutSchemaData = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SettingsSyslogSettingsPutSchemaData model module.
   * @module model/SettingsSyslogSettingsPutSchemaData
   * @version 2.1
   */

  /**
   * Constructs a new <code>SettingsSyslogSettingsPutSchemaData</code>.
   * Data
   * @alias module:model/SettingsSyslogSettingsPutSchemaData
   * @class
   */
  ...
  /**
   * Constructs a <code>SettingsSyslogSettingsPutSchemaData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SettingsSyslogSettingsPutSchemaData} obj Optional instance to populate.
   * @return {module:model/SettingsSyslogSettingsPutSchemaData} The populated <code>SettingsSyslogSettingsPutSchemaData</code> instance.
   */
   ...
   * @member {module:model/SettingsSyslogSettingsPutSchemaData.FormatEnum} format
   */
