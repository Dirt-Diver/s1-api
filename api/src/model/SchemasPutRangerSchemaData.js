...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.SchemasPutRangerSchemaData = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.SchemasRangerSettingsSchema200DataRestrictions, root.S1MgmtApi.SchemasRangerSettingsSchema200DataSpecificPorts);
  }
}(this, function(ApiClient, SchemasRangerSettingsSchema200DataRestrictions, SchemasRangerSettingsSchema200DataSpecificPorts) {
  'use strict';

  /**
   * The SchemasPutRangerSchemaData model module.
   * @module model/SchemasPutRangerSchemaData
   * @version 2.1
   */

  /**
   * Constructs a new <code>SchemasPutRangerSchemaData</code>.
   * Data
   * @alias module:model/SchemasPutRangerSchemaData
   * @class
   */
  ...
  /**
   * Constructs a <code>SchemasPutRangerSchemaData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SchemasPutRangerSchemaData} obj Optional instance to populate.
   * @return {module:model/SchemasPutRangerSchemaData} The populated <code>SchemasPutRangerSchemaData</code> instance.
   */
