...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.DeviceControlSchemasDeviceSchemaMany200Data = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DeviceControlSchemasDeviceSchemaMany200Data model module.
   * @module model/DeviceControlSchemasDeviceSchemaMany200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>DeviceControlSchemasDeviceSchemaMany200Data</code>.
   * @alias module:model/DeviceControlSchemasDeviceSchemaMany200Data
   * @class
   */
  ...
  /**
   * Constructs a <code>DeviceControlSchemasDeviceSchemaMany200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeviceControlSchemasDeviceSchemaMany200Data} obj Optional instance to populate.
   * @return {module:model/DeviceControlSchemasDeviceSchemaMany200Data} The populated <code>DeviceControlSchemasDeviceSchemaMany200Data</code> instance.
   */
   ...
   * @member {module:model/DeviceControlSchemasDeviceSchemaMany200Data.RuleTypeEnum} ruleType
   */
  ...
  /**
   * Scope of the rule
   * @member {module:model/DeviceControlSchemasDeviceSchemaMany200Data.ScopeEnum} scope
   */
   ...
   * @member {module:model/DeviceControlSchemasDeviceSchemaMany200Data.ActionEnum} action
   */
   ...
   * @member {module:model/DeviceControlSchemasDeviceSchemaMany200Data.InterfaceEnum} _interface
   */
   ...
   * @member {module:model/DeviceControlSchemasDeviceSchemaMany200Data.StatusEnum} status
   */
  exports.prototype.status = undefined;

  /**
   * Access permission
   * @member {module:model/DeviceControlSchemasDeviceSchemaMany200Data.AccessPermissionEnum} accessPermission
   */
