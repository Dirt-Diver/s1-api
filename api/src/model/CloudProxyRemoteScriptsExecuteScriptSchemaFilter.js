...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.CloudProxyRemoteScriptsExecuteScriptSchemaFilter = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CloudProxyRemoteScriptsExecuteScriptSchemaFilter model module.
   * @module model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter
   * @version 2.1
   */

  /**
   * Constructs a new <code>CloudProxyRemoteScriptsExecuteScriptSchemaFilter</code>.
   * Applied filter
   * @alias module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter
   * @class
   */
  ...
  /**
   * Constructs a <code>CloudProxyRemoteScriptsExecuteScriptSchemaFilter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter} obj Optional instance to populate.
   * @return {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter} The populated <code>CloudProxyRemoteScriptsExecuteScriptSchemaFilter</code> instance.
   */
   ...
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.MitigationModeSuspiciousEnum} mitigationModeSuspicious
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.AppsVulnerabilityStatusesNinEnum>} appsVulnerabilityStatusesNin
   */
  exports.prototype.appsVulnerabilityStatusesNin = undefined;

  /**
   * Not included scan statuses
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.ScanStatusesNinEnum>} scanStatusesNin
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.MachineTypesEnum>} machineTypes
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.MissingPermissionsNinEnum>} missingPermissionsNin
   */
  exports.prototype.missingPermissionsNin = undefined;

  /**
   * Migration status
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.MigrationStatusEnum} migrationStatus
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.OsTypesNinEnum>} osTypesNin
   */
   ...
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.MitigationModeEnum} mitigationMode
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.UserActionsNeededNinEnum>} userActionsNeededNin
   */
  exports.prototype.userActionsNeededNin = undefined;

  /**
   * Status of Ranger
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.RangerStatusesEnum>} rangerStatuses
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.ConsoleMigrationStatusesNinEnum>} consoleMigrationStatusesNin
   */
   ...
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.RangerStatusEnum} rangerStatus
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.ScanStatusesEnum>} scanStatuses
   */
  ...
  /**
   * Included OS types
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.OsTypesEnum>} osTypes
   */
  exports.prototype.osTypes = undefined;

  /**
   * Apps vulnerability status in
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.AppsVulnerabilityStatusesEnum>} appsVulnerabilityStatuses
   */
  ...
  /**
   * Scan status
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.ScanStatusEnum} scanStatus
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.UserActionsNeededEnum>} userActionsNeeded
   */
  ...
  /**
   * OS architecture
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.OsArchEnum} osArch
   */
   ...
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.ThreatMitigationStatusEnum} threatMitigationStatus
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.NetworkStatusesEnum>} networkStatuses
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.InstallerTypesEnum>} installerTypes
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.MissingPermissionsEnum>} missingPermissions
   */
  exports.prototype.missingPermissions = undefined;

  /**
   * Exclude Agents installed with these package types
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.InstallerTypesNinEnum>} installerTypesNin
   */
  exports.prototype.installerTypesNin = undefined;

  /**
   * Not included machine types
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.MachineTypesNinEnum>} machineTypesNin
   */
   ...
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.RangerStatusesNinEnum>} rangerStatusesNin
   */
   ...
   * @member {module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.RsoLevelEnum} rsoLevel
   */
  ...
  /**
   * Migration status in
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.ConsoleMigrationStatusesEnum>} consoleMigrationStatuses
   */
  ...
  /**
   * Included network statuses
   * @member {Array.<module:model/CloudProxyRemoteScriptsExecuteScriptSchemaFilter.NetworkStatusesNinEnum>} networkStatusesNin
   */
