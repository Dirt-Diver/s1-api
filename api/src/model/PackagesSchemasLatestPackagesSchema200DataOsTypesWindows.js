...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.PackagesSchemasLatestPackagesSchema200DataOsTypesWindows = factory(root.S1MgmtApi.ApiClient, root.S1MgmtApi.PackagesSchemasLatestPackagesSchema200DataOsTypesSites);
  }
}(this, function(ApiClient, PackagesSchemasLatestPackagesSchema200DataOsTypesSites) {
  'use strict';

  /**
   * The PackagesSchemasLatestPackagesSchema200DataOsTypesWindows model module.
   * @module model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows
   * @version 2.1
   */

  /**
   * Constructs a new <code>PackagesSchemasLatestPackagesSchema200DataOsTypesWindows</code>.
   * @alias module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows
   * @class
   */
  ...
  /**
   * Constructs a <code>PackagesSchemasLatestPackagesSchema200DataOsTypesWindows</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows} obj Optional instance to populate.
   * @return {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows} The populated <code>PackagesSchemasLatestPackagesSchema200DataOsTypesWindows</code> instance.
   */
  ...
  /**
   * Platform type
   * @member {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows.PlatformTypeEnum} platformType
   */
  ...
  /**
   * File extension
   * @member {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows.FileExtensionEnum} fileExtension
   */
   ...
   * @member {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows.OsArchEnum} osArch
   */
  ...
  /**
   * Package type
   * @member {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows.PackageTypeEnum} packageType
   */
  ...
  /**
   * Platform type
   * @member {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows.OsTypeEnum} osType
   */
  ...
  /**
   * Status
   * @member {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows.StatusEnum} status
   */
   ...
   * @member {module:model/PackagesSchemasLatestPackagesSchema200DataOsTypesWindows.ScopeLevelEnum} scopeLevel
   */
