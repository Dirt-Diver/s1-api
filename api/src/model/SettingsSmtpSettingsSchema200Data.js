...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S1MgmtApi.SettingsSmtpSettingsSchema200Data = factory(root.S1MgmtApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SettingsSmtpSettingsSchema200Data model module.
   * @module model/SettingsSmtpSettingsSchema200Data
   * @version 2.1
   */

  /**
   * Constructs a new <code>SettingsSmtpSettingsSchema200Data</code>.
   * Response data
   * @alias module:model/SettingsSmtpSettingsSchema200Data
   * @class
   */
  ...
  /**
   * Constructs a <code>SettingsSmtpSettingsSchema200Data</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SettingsSmtpSettingsSchema200Data} obj Optional instance to populate.
   * @return {module:model/SettingsSmtpSettingsSchema200Data} The populated <code>SettingsSmtpSettingsSchema200Data</code> instance.
   */
   ...
   * @member {module:model/SettingsSmtpSettingsSchema200Data.EncryptionEnum} encryption
   */
