...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationsSchemasUpdateLocationSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.LocationsSchemasUpdateLocationSchemaData();
      });

      it('should create an instance of LocationsSchemasUpdateLocationSchemaData', function() {
        // TODO: update the code to test LocationsSchemasUpdateLocationSchemaData
        expect(instance).to.be.a(S1MgmtApi.LocationsSchemasUpdateLocationSchemaData);
      });
