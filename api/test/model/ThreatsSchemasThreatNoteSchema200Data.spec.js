...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatNoteSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatNoteSchema200Data();
      });

      it('should create an instance of ThreatsSchemasThreatNoteSchema200Data', function() {
        // TODO: update the code to test ThreatsSchemasThreatNoteSchema200Data
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatNoteSchema200Data);
      });
