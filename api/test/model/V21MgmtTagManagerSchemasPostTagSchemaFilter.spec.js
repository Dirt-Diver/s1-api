...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21MgmtTagManagerSchemasPostTagSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21MgmtTagManagerSchemasPostTagSchemaFilter();
      });

      it('should create an instance of V21MgmtTagManagerSchemasPostTagSchemaFilter', function() {
        // TODO: update the code to test V21MgmtTagManagerSchemasPostTagSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21MgmtTagManagerSchemasPostTagSchemaFilter);
      });
