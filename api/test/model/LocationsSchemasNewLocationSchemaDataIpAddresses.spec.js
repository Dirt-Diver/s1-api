...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationsSchemasNewLocationSchemaDataIpAddresses', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.LocationsSchemasNewLocationSchemaDataIpAddresses();
      });

      it('should create an instance of LocationsSchemasNewLocationSchemaDataIpAddresses', function() {
        // TODO: update the code to test LocationsSchemasNewLocationSchemaDataIpAddresses
        expect(instance).to.be.a(S1MgmtApi.LocationsSchemasNewLocationSchemaDataIpAddresses);
      });
