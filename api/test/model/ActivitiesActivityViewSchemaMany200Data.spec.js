...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivitiesActivityViewSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ActivitiesActivityViewSchemaMany200Data();
      });

      it('should create an instance of ActivitiesActivityViewSchemaMany200Data', function() {
        // TODO: update the code to test ActivitiesActivityViewSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.ActivitiesActivityViewSchemaMany200Data);
      });
      ...
      it('should have the property activityUuid (base name: "activityUuid")', function() {
        // TODO: update the code to test the property activityUuid
        expect(instance).to.have.property('activityUuid');
        // expect(instance.activityUuid).to.be(expectedValueLiteral);
      });
