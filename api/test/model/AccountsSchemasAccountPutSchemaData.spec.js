...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountsSchemasAccountPutSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.AccountsSchemasAccountPutSchemaData();
      });

      it('should create an instance of AccountsSchemasAccountPutSchemaData', function() {
        // TODO: update the code to test AccountsSchemasAccountPutSchemaData
        expect(instance).to.be.a(S1MgmtApi.AccountsSchemasAccountPutSchemaData);
      });
