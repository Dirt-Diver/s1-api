...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SchemasPutRangerSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SchemasPutRangerSchemaFilter();
      });

      it('should create an instance of SchemasPutRangerSchemaFilter', function() {
        // TODO: update the code to test SchemasPutRangerSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.SchemasPutRangerSchemaFilter);
      });
