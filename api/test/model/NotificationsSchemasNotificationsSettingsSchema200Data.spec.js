...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NotificationsSchemasNotificationsSettingsSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.NotificationsSchemasNotificationsSettingsSchema200Data();
      });

      it('should create an instance of NotificationsSchemasNotificationsSettingsSchema200Data', function() {
        // TODO: update the code to test NotificationsSchemasNotificationsSettingsSchema200Data
        expect(instance).to.be.a(S1MgmtApi.NotificationsSchemasNotificationsSettingsSchema200Data);
      });
