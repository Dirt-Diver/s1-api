...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21RulesSchemasPostRuleSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21RulesSchemasPostRuleSchemaFilter();
      });

      it('should create an instance of V21RulesSchemasPostRuleSchemaFilter', function() {
        // TODO: update the code to test V21RulesSchemasPostRuleSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21RulesSchemasPostRuleSchemaFilter);
      });
