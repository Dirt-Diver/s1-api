...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersSchemasUserSchema200DataSiteRoles', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.UsersSchemasUserSchema200DataSiteRoles();
      });

      it('should create an instance of UsersSchemasUserSchema200DataSiteRoles', function() {
        // TODO: update the code to test UsersSchemasUserSchema200DataSiteRoles
        expect(instance).to.be.a(S1MgmtApi.UsersSchemasUserSchema200DataSiteRoles);
      });
