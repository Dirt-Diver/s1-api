...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesPostSiteSchemaDataPolicy', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesPostSiteSchemaDataPolicy();
      });

      it('should create an instance of SitesPostSiteSchemaDataPolicy', function() {
        // TODO: update the code to test SitesPostSiteSchemaDataPolicy
        expect(instance).to.be.a(S1MgmtApi.SitesPostSiteSchemaDataPolicy);
      });
