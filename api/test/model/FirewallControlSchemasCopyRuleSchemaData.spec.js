...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FirewallControlSchemasCopyRuleSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FirewallControlSchemasCopyRuleSchemaData();
      });

      it('should create an instance of FirewallControlSchemasCopyRuleSchemaData', function() {
        // TODO: update the code to test FirewallControlSchemasCopyRuleSchemaData
        expect(instance).to.be.a(S1MgmtApi.FirewallControlSchemasCopyRuleSchemaData);
      });
