...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesSiteResponseSchema200DataAllSites', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesSiteResponseSchema200DataAllSites();
      });

      it('should create an instance of SitesSiteResponseSchema200DataAllSites', function() {
        // TODO: update the code to test SitesSiteResponseSchema200DataAllSites
        expect(instance).to.be.a(S1MgmtApi.SitesSiteResponseSchema200DataAllSites);
      });
