...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsPutAddAgentsSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.GroupsPutAddAgentsSchemaFilter();
      });

      it('should create an instance of GroupsPutAddAgentsSchemaFilter', function() {
        // TODO: update the code to test GroupsPutAddAgentsSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.GroupsPutAddAgentsSchemaFilter);
      });
