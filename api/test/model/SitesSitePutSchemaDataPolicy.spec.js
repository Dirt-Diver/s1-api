...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesSitePutSchemaDataPolicy', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesSitePutSchemaDataPolicy();
      });

      it('should create an instance of SitesSitePutSchemaDataPolicy', function() {
        // TODO: update the code to test SitesSitePutSchemaDataPolicy
        expect(instance).to.be.a(S1MgmtApi.SitesSitePutSchemaDataPolicy);
      });
