...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21SchemasPostUserConfigSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21SchemasPostUserConfigSchemaFilter();
      });

      it('should create an instance of V21SchemasPostUserConfigSchemaFilter', function() {
        // TODO: update the code to test V21SchemasPostUserConfigSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21SchemasPostUserConfigSchemaFilter);
      });
