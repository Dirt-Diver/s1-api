...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21RsoSchemasPendingExecutionsPaginatedResponseSchemaMany200ScriptData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21RsoSchemasPendingExecutionsPaginatedResponseSchemaMany200ScriptData();
      });

      it('should create an instance of V21RsoSchemasPendingExecutionsPaginatedResponseSchemaMany200ScriptData', function() {
        // TODO: update the code to test V21RsoSchemasPendingExecutionsPaginatedResponseSchemaMany200ScriptData
        expect(instance).to.be.a(S1MgmtApi.V21RsoSchemasPendingExecutionsPaginatedResponseSchemaMany200ScriptData);
      });
