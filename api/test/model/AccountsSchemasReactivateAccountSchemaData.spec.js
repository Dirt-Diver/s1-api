...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountsSchemasReactivateAccountSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.AccountsSchemasReactivateAccountSchemaData();
      });

      it('should create an instance of AccountsSchemasReactivateAccountSchemaData', function() {
        // TODO: update the code to test AccountsSchemasReactivateAccountSchemaData
        expect(instance).to.be.a(S1MgmtApi.AccountsSchemasReactivateAccountSchemaData);
      });
