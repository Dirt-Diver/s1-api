...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SettingsSmtpSettingsSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SettingsSmtpSettingsSchema200Data();
      });

      it('should create an instance of SettingsSmtpSettingsSchema200Data', function() {
        // TODO: update the code to test SettingsSmtpSettingsSchema200Data
        expect(instance).to.be.a(S1MgmtApi.SettingsSmtpSettingsSchema200Data);
      });
