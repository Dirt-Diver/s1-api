...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ApplicationManagementApplicationManagementSchemasScanPostSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ApplicationManagementApplicationManagementSchemasScanPostSchemaFilter();
      });

      it('should create an instance of V21ApplicationManagementApplicationManagementSchemasScanPostSchemaFilter', function() {
        // TODO: update the code to test V21ApplicationManagementApplicationManagementSchemasScanPostSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21ApplicationManagementApplicationManagementSchemasScanPostSchemaFilter);
      });
