...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RemoteOpsSchemasStartCollectionResponseDataSchema202Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.RemoteOpsSchemasStartCollectionResponseDataSchema202Data();
      });

      it('should create an instance of RemoteOpsSchemasStartCollectionResponseDataSchema202Data', function() {
        // TODO: update the code to test RemoteOpsSchemasStartCollectionResponseDataSchema202Data
        expect(instance).to.be.a(S1MgmtApi.RemoteOpsSchemasStartCollectionResponseDataSchema202Data);
      });
