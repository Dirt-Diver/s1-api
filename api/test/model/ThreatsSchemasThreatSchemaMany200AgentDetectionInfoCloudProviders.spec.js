...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatSchemaMany200AgentDetectionInfoCloudProviders', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatSchemaMany200AgentDetectionInfoCloudProviders();
      });

      it('should create an instance of ThreatsSchemasThreatSchemaMany200AgentDetectionInfoCloudProviders', function() {
        // TODO: update the code to test ThreatsSchemasThreatSchemaMany200AgentDetectionInfoCloudProviders
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatSchemaMany200AgentDetectionInfoCloudProviders);
      });
