...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersSchemasUpdateUserSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.UsersSchemasUpdateUserSchemaData();
      });

      it('should create an instance of UsersSchemasUpdateUserSchemaData', function() {
        // TODO: update the code to test UsersSchemasUpdateUserSchemaData
        expect(instance).to.be.a(S1MgmtApi.UsersSchemasUpdateUserSchemaData);
      });
