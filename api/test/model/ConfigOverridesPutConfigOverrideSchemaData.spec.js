...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigOverridesPutConfigOverrideSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ConfigOverridesPutConfigOverrideSchemaData();
      });

      it('should create an instance of ConfigOverridesPutConfigOverrideSchemaData', function() {
        // TODO: update the code to test ConfigOverridesPutConfigOverrideSchemaData
        expect(instance).to.be.a(S1MgmtApi.ConfigOverridesPutConfigOverrideSchemaData);
      });
