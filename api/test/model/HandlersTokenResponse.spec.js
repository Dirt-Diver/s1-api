...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HandlersTokenResponse', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.HandlersTokenResponse();
      });

      it('should create an instance of HandlersTokenResponse', function() {
        // TODO: update the code to test HandlersTokenResponse
        expect(instance).to.be.a(S1MgmtApi.HandlersTokenResponse);
      });
