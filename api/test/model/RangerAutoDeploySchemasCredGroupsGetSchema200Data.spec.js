...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RangerAutoDeploySchemasCredGroupsGetSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.RangerAutoDeploySchemasCredGroupsGetSchema200Data();
      });

      it('should create an instance of RangerAutoDeploySchemasCredGroupsGetSchema200Data', function() {
        // TODO: update the code to test RangerAutoDeploySchemasCredGroupsGetSchema200Data
        expect(instance).to.be.a(S1MgmtApi.RangerAutoDeploySchemasCredGroupsGetSchema200Data);
      });
