...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AgentsSchemasAgentsBroadcastActionSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.AgentsSchemasAgentsBroadcastActionSchemaFilter();
      });

      it('should create an instance of AgentsSchemasAgentsBroadcastActionSchemaFilter', function() {
        // TODO: update the code to test AgentsSchemasAgentsBroadcastActionSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.AgentsSchemasAgentsBroadcastActionSchemaFilter);
      });
