...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21CloudFunnelSchemasOnboardingPostSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21CloudFunnelSchemasOnboardingPostSchemaData();
      });

      it('should create an instance of V21CloudFunnelSchemasOnboardingPostSchemaData', function() {
        // TODO: update the code to test V21CloudFunnelSchemasOnboardingPostSchemaData
        expect(instance).to.be.a(S1MgmtApi.V21CloudFunnelSchemasOnboardingPostSchemaData);
      });
