...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RemoteOpsSchemasGetForensicsTaskResultDataSchema200DataCollectionArtifacts', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.RemoteOpsSchemasGetForensicsTaskResultDataSchema200DataCollectionArtifacts();
      });

      it('should create an instance of RemoteOpsSchemasGetForensicsTaskResultDataSchema200DataCollectionArtifacts', function() {
        // TODO: update the code to test RemoteOpsSchemasGetForensicsTaskResultDataSchema200DataCollectionArtifacts
        expect(instance).to.be.a(S1MgmtApi.RemoteOpsSchemasGetForensicsTaskResultDataSchema200DataCollectionArtifacts);
      });
