...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21DataExporterSchemaPostDestinationProfileRequestSchema', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21DataExporterSchemaPostDestinationProfileRequestSchema();
      });

      it('should create an instance of V21DataExporterSchemaPostDestinationProfileRequestSchema', function() {
        // TODO: update the code to test V21DataExporterSchemaPostDestinationProfileRequestSchema
        expect(instance).to.be.a(S1MgmtApi.V21DataExporterSchemaPostDestinationProfileRequestSchema);
      });
