...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExclusionsSchemasExclusionSchemaGetMany200Scope', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ExclusionsSchemasExclusionSchemaGetMany200Scope();
      });

      it('should create an instance of ExclusionsSchemasExclusionSchemaGetMany200Scope', function() {
        // TODO: update the code to test ExclusionsSchemasExclusionSchemaGetMany200Scope
        expect(instance).to.be.a(S1MgmtApi.ExclusionsSchemasExclusionSchemaGetMany200Scope);
      });
