...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FiltersFiltersNewFilterSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FiltersFiltersNewFilterSchemaFilter();
      });

      it('should create an instance of FiltersFiltersNewFilterSchemaFilter', function() {
        // TODO: update the code to test FiltersFiltersNewFilterSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.FiltersFiltersNewFilterSchemaFilter);
      });
