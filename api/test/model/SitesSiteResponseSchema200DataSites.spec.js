...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesSiteResponseSchema200DataSites', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesSiteResponseSchema200DataSites();
      });

      it('should create an instance of SitesSiteResponseSchema200DataSites', function() {
        // TODO: update the code to test SitesSiteResponseSchema200DataSites
        expect(instance).to.be.a(S1MgmtApi.SitesSiteResponseSchema200DataSites);
      });
