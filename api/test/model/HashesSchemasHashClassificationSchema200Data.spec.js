...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HashesSchemasHashClassificationSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.HashesSchemasHashClassificationSchema200Data();
      });

      it('should create an instance of HashesSchemasHashClassificationSchema200Data', function() {
        // TODO: update the code to test HashesSchemasHashClassificationSchema200Data
        expect(instance).to.be.a(S1MgmtApi.HashesSchemasHashClassificationSchema200Data);
      });
