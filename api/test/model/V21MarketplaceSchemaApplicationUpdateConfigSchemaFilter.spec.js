...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21MarketplaceSchemaApplicationUpdateConfigSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21MarketplaceSchemaApplicationUpdateConfigSchemaFilter();
      });

      it('should create an instance of V21MarketplaceSchemaApplicationUpdateConfigSchemaFilter', function() {
        // TODO: update the code to test V21MarketplaceSchemaApplicationUpdateConfigSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21MarketplaceSchemaApplicationUpdateConfigSchemaFilter);
      });
