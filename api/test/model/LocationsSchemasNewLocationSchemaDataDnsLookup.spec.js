...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationsSchemasNewLocationSchemaDataDnsLookup', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.LocationsSchemasNewLocationSchemaDataDnsLookup();
      });

      it('should create an instance of LocationsSchemasNewLocationSchemaDataDnsLookup', function() {
        // TODO: update the code to test LocationsSchemasNewLocationSchemaDataDnsLookup
        expect(instance).to.be.a(S1MgmtApi.LocationsSchemasNewLocationSchemaDataDnsLookup);
      });
