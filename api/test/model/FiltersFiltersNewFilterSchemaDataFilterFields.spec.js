...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FiltersFiltersNewFilterSchemaDataFilterFields', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FiltersFiltersNewFilterSchemaDataFilterFields();
      });

      it('should create an instance of FiltersFiltersNewFilterSchemaDataFilterFields', function() {
        // TODO: update the code to test FiltersFiltersNewFilterSchemaDataFilterFields
        expect(instance).to.be.a(S1MgmtApi.FiltersFiltersNewFilterSchemaDataFilterFields);
      });
