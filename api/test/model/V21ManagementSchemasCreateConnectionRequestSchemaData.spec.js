...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ManagementSchemasCreateConnectionRequestSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ManagementSchemasCreateConnectionRequestSchemaData();
      });

      it('should create an instance of V21ManagementSchemasCreateConnectionRequestSchemaData', function() {
        // TODO: update the code to test V21ManagementSchemasCreateConnectionRequestSchemaData
        expect(instance).to.be.a(S1MgmtApi.V21ManagementSchemasCreateConnectionRequestSchemaData);
      });
