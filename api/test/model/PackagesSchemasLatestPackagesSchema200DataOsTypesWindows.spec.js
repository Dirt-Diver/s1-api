...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackagesSchemasLatestPackagesSchema200DataOsTypesWindows', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.PackagesSchemasLatestPackagesSchema200DataOsTypesWindows();
      });

      it('should create an instance of PackagesSchemasLatestPackagesSchema200DataOsTypesWindows', function() {
        // TODO: update the code to test PackagesSchemasLatestPackagesSchema200DataOsTypesWindows
        expect(instance).to.be.a(S1MgmtApi.PackagesSchemasLatestPackagesSchema200DataOsTypesWindows);
      });
