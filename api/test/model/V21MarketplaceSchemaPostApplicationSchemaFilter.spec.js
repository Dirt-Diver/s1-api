...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21MarketplaceSchemaPostApplicationSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21MarketplaceSchemaPostApplicationSchemaFilter();
      });

      it('should create an instance of V21MarketplaceSchemaPostApplicationSchemaFilter', function() {
        // TODO: update the code to test V21MarketplaceSchemaPostApplicationSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21MarketplaceSchemaPostApplicationSchemaFilter);
      });
