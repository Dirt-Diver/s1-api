...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21SchemasDeleteCustomAppConfigurationSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21SchemasDeleteCustomAppConfigurationSchemaData();
      });

      it('should create an instance of V21SchemasDeleteCustomAppConfigurationSchemaData', function() {
        // TODO: update the code to test V21SchemasDeleteCustomAppConfigurationSchemaData
        expect(instance).to.be.a(S1MgmtApi.V21SchemasDeleteCustomAppConfigurationSchemaData);
      });
