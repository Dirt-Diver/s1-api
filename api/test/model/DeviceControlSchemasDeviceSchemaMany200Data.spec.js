...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeviceControlSchemasDeviceSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.DeviceControlSchemasDeviceSchemaMany200Data();
      });

      it('should create an instance of DeviceControlSchemasDeviceSchemaMany200Data', function() {
        // TODO: update the code to test DeviceControlSchemasDeviceSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.DeviceControlSchemasDeviceSchemaMany200Data);
      });
