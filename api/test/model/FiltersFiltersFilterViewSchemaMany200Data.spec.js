...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FiltersFiltersFilterViewSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FiltersFiltersFilterViewSchemaMany200Data();
      });

      it('should create an instance of FiltersFiltersFilterViewSchemaMany200Data', function() {
        // TODO: update the code to test FiltersFiltersFilterViewSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.FiltersFiltersFilterViewSchemaMany200Data);
      });
