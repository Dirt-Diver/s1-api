...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatsFetchFileRequestSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatsFetchFileRequestSchemaFilter();
      });

      it('should create an instance of ThreatsSchemasThreatsFetchFileRequestSchemaFilter', function() {
        // TODO: update the code to test ThreatsSchemasThreatsFetchFileRequestSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatsFetchFileRequestSchemaFilter);
      });
