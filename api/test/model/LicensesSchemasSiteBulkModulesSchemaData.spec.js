...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LicensesSchemasSiteBulkModulesSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.LicensesSchemasSiteBulkModulesSchemaData();
      });

      it('should create an instance of LicensesSchemasSiteBulkModulesSchemaData', function() {
        // TODO: update the code to test LicensesSchemasSiteBulkModulesSchemaData
        expect(instance).to.be.a(S1MgmtApi.LicensesSchemasSiteBulkModulesSchemaData);
      });
