...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeviceControlSchemasReorderSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.DeviceControlSchemasReorderSchemaFilter();
      });

      it('should create an instance of DeviceControlSchemasReorderSchemaFilter', function() {
        // TODO: update the code to test DeviceControlSchemasReorderSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.DeviceControlSchemasReorderSchemaFilter);
      });
