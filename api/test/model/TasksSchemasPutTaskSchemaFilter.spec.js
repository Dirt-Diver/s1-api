...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TasksSchemasPutTaskSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.TasksSchemasPutTaskSchemaFilter();
      });

      it('should create an instance of TasksSchemasPutTaskSchemaFilter', function() {
        // TODO: update the code to test TasksSchemasPutTaskSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.TasksSchemasPutTaskSchemaFilter);
      });
