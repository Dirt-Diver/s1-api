...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21DataExporterSchemaSkylightUploadResults200DataThreatResults', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21DataExporterSchemaSkylightUploadResults200DataThreatResults();
      });

      it('should create an instance of V21DataExporterSchemaSkylightUploadResults200DataThreatResults', function() {
        // TODO: update the code to test V21DataExporterSchemaSkylightUploadResults200DataThreatResults
        expect(instance).to.be.a(S1MgmtApi.V21DataExporterSchemaSkylightUploadResults200DataThreatResults);
      });
