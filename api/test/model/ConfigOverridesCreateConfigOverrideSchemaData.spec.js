...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigOverridesCreateConfigOverrideSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ConfigOverridesCreateConfigOverrideSchemaData();
      });

      it('should create an instance of ConfigOverridesCreateConfigOverrideSchemaData', function() {
        // TODO: update the code to test ConfigOverridesCreateConfigOverrideSchemaData
        expect(instance).to.be.a(S1MgmtApi.ConfigOverridesCreateConfigOverrideSchemaData);
      });
