...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersSchemasCreateUserSchemaDataScopeRoles', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.UsersSchemasCreateUserSchemaDataScopeRoles();
      });

      it('should create an instance of UsersSchemasCreateUserSchemaDataScopeRoles', function() {
        // TODO: update the code to test UsersSchemasCreateUserSchemaDataScopeRoles
        expect(instance).to.be.a(S1MgmtApi.UsersSchemasCreateUserSchemaDataScopeRoles);
      });
