...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ActivationSchemasUserActivationIdsRequestWrapperFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ActivationSchemasUserActivationIdsRequestWrapperFilter();
      });

      it('should create an instance of V21ActivationSchemasUserActivationIdsRequestWrapperFilter', function() {
        // TODO: update the code to test V21ActivationSchemasUserActivationIdsRequestWrapperFilter
        expect(instance).to.be.a(S1MgmtApi.V21ActivationSchemasUserActivationIdsRequestWrapperFilter);
      });
