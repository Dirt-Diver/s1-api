...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesDuplicateSiteSchemaDataPolicy', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesDuplicateSiteSchemaDataPolicy();
      });

      it('should create an instance of SitesDuplicateSiteSchemaDataPolicy', function() {
        // TODO: update the code to test SitesDuplicateSiteSchemaDataPolicy
        expect(instance).to.be.a(S1MgmtApi.SitesDuplicateSiteSchemaDataPolicy);
      });
