...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesSiteDataWithUserSchemaDataUser', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesSiteDataWithUserSchemaDataUser();
      });

      it('should create an instance of SitesSiteDataWithUserSchemaDataUser', function() {
        // TODO: update the code to test SitesSiteDataWithUserSchemaDataUser
        expect(instance).to.be.a(S1MgmtApi.SitesSiteDataWithUserSchemaDataUser);
      });
