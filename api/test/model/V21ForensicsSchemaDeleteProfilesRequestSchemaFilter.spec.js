...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ForensicsSchemaDeleteProfilesRequestSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ForensicsSchemaDeleteProfilesRequestSchemaFilter();
      });

      it('should create an instance of V21ForensicsSchemaDeleteProfilesRequestSchemaFilter', function() {
        // TODO: update the code to test V21ForensicsSchemaDeleteProfilesRequestSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21ForensicsSchemaDeleteProfilesRequestSchemaFilter);
      });
