...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21DataExporterSchemaSkylightUploadResults200DataTaskResults', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21DataExporterSchemaSkylightUploadResults200DataTaskResults();
      });

      it('should create an instance of V21DataExporterSchemaSkylightUploadResults200DataTaskResults', function() {
        // TODO: update the code to test V21DataExporterSchemaSkylightUploadResults200DataTaskResults
        expect(instance).to.be.a(S1MgmtApi.V21DataExporterSchemaSkylightUploadResults200DataTaskResults);
      });
