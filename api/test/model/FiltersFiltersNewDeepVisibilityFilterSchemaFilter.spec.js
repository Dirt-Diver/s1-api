...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FiltersFiltersNewDeepVisibilityFilterSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FiltersFiltersNewDeepVisibilityFilterSchemaFilter();
      });

      it('should create an instance of FiltersFiltersNewDeepVisibilityFilterSchemaFilter', function() {
        // TODO: update the code to test FiltersFiltersNewDeepVisibilityFilterSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.FiltersFiltersNewDeepVisibilityFilterSchemaFilter);
      });
