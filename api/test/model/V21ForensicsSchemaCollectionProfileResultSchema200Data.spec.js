...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ForensicsSchemaCollectionProfileResultSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ForensicsSchemaCollectionProfileResultSchema200Data();
      });

      it('should create an instance of V21ForensicsSchemaCollectionProfileResultSchema200Data', function() {
        // TODO: update the code to test V21ForensicsSchemaCollectionProfileResultSchema200Data
        expect(instance).to.be.a(S1MgmtApi.V21ForensicsSchemaCollectionProfileResultSchema200Data);
      });
