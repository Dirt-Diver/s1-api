...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigOverridesConfigOverrideSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ConfigOverridesConfigOverrideSchemaMany200Data();
      });

      it('should create an instance of ConfigOverridesConfigOverrideSchemaMany200Data', function() {
        // TODO: update the code to test ConfigOverridesConfigOverrideSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.ConfigOverridesConfigOverrideSchemaMany200Data);
      });
