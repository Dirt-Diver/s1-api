...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TagsSchemasGetTagSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.TagsSchemasGetTagSchemaMany200Data();
      });

      it('should create an instance of TagsSchemasGetTagSchemaMany200Data', function() {
        // TODO: update the code to test TagsSchemasGetTagSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.TagsSchemasGetTagSchemaMany200Data);
      });
