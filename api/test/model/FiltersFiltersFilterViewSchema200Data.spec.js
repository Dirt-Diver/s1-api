...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FiltersFiltersFilterViewSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FiltersFiltersFilterViewSchema200Data();
      });

      it('should create an instance of FiltersFiltersFilterViewSchema200Data', function() {
        // TODO: update the code to test FiltersFiltersFilterViewSchema200Data
        expect(instance).to.be.a(S1MgmtApi.FiltersFiltersFilterViewSchema200Data);
      });
