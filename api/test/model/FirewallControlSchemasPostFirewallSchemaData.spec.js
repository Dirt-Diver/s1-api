...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FirewallControlSchemasPostFirewallSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FirewallControlSchemasPostFirewallSchemaData();
      });

      it('should create an instance of FirewallControlSchemasPostFirewallSchemaData', function() {
        // TODO: update the code to test FirewallControlSchemasPostFirewallSchemaData
        expect(instance).to.be.a(S1MgmtApi.FirewallControlSchemasPostFirewallSchemaData);
      });
