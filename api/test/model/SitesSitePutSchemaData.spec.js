...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesSitePutSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesSitePutSchemaData();
      });

      it('should create an instance of SitesSitePutSchemaData', function() {
        // TODO: update the code to test SitesSitePutSchemaData
        expect(instance).to.be.a(S1MgmtApi.SitesSitePutSchemaData);
      });
