...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ForensicsSchemaGetCollectionProfileResultSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ForensicsSchemaGetCollectionProfileResultSchemaMany200Data();
      });

      it('should create an instance of V21ForensicsSchemaGetCollectionProfileResultSchemaMany200Data', function() {
        // TODO: update the code to test V21ForensicsSchemaGetCollectionProfileResultSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.V21ForensicsSchemaGetCollectionProfileResultSchemaMany200Data);
      });
