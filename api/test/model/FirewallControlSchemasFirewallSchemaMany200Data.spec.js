...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FirewallControlSchemasFirewallSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FirewallControlSchemasFirewallSchemaMany200Data();
      });

      it('should create an instance of FirewallControlSchemasFirewallSchemaMany200Data', function() {
        // TODO: update the code to test FirewallControlSchemasFirewallSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.FirewallControlSchemasFirewallSchemaMany200Data);
      });
