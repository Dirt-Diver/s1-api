...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationsSchemasNewLocationSchemaDataDnsServers', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.LocationsSchemasNewLocationSchemaDataDnsServers();
      });

      it('should create an instance of LocationsSchemasNewLocationSchemaDataDnsServers', function() {
        // TODO: update the code to test LocationsSchemasNewLocationSchemaDataDnsServers
        expect(instance).to.be.a(S1MgmtApi.LocationsSchemasNewLocationSchemaDataDnsServers);
      });
