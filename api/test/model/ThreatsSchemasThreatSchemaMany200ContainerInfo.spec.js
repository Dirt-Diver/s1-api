...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatSchemaMany200ContainerInfo', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatSchemaMany200ContainerInfo();
      });

      it('should create an instance of ThreatsSchemasThreatSchemaMany200ContainerInfo', function() {
        // TODO: update the code to test ThreatsSchemasThreatSchemaMany200ContainerInfo
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatSchemaMany200ContainerInfo);
      });
