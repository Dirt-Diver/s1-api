...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PoliciesTenantPolicySchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.PoliciesTenantPolicySchemaData();
      });

      it('should create an instance of PoliciesTenantPolicySchemaData', function() {
        // TODO: update the code to test PoliciesTenantPolicySchemaData
        expect(instance).to.be.a(S1MgmtApi.PoliciesTenantPolicySchemaData);
      });
