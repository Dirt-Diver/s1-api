...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExclusionsSchemasExclusionSchemaGetMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ExclusionsSchemasExclusionSchemaGetMany200Data();
      });

      it('should create an instance of ExclusionsSchemasExclusionSchemaGetMany200Data', function() {
        // TODO: update the code to test ExclusionsSchemasExclusionSchemaGetMany200Data
        expect(instance).to.be.a(S1MgmtApi.ExclusionsSchemasExclusionSchemaGetMany200Data);
      });
      ...
      it('should have the property inAppInventory (base name: "inAppInventory")', function() {
        // TODO: update the code to test the property inAppInventory
        expect(instance).to.have.property('inAppInventory');
        // expect(instance.inAppInventory).to.be(expectedValueLiteral);
      });
