...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasDvMarkAsThreatSchemaDataEvents', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasDvMarkAsThreatSchemaDataEvents();
      });

      it('should create an instance of ThreatsSchemasDvMarkAsThreatSchemaDataEvents', function() {
        // TODO: update the code to test ThreatsSchemasDvMarkAsThreatSchemaDataEvents
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasDvMarkAsThreatSchemaDataEvents);
      });
