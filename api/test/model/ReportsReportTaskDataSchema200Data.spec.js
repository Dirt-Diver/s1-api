...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReportsReportTaskDataSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ReportsReportTaskDataSchema200Data();
      });

      it('should create an instance of ReportsReportTaskDataSchema200Data', function() {
        // TODO: update the code to test ReportsReportTaskDataSchema200Data
        expect(instance).to.be.a(S1MgmtApi.ReportsReportTaskDataSchema200Data);
      });
