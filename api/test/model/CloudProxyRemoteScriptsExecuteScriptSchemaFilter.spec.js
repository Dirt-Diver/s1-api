...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CloudProxyRemoteScriptsExecuteScriptSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.CloudProxyRemoteScriptsExecuteScriptSchemaFilter();
      });

      it('should create an instance of CloudProxyRemoteScriptsExecuteScriptSchemaFilter', function() {
        // TODO: update the code to test CloudProxyRemoteScriptsExecuteScriptSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.CloudProxyRemoteScriptsExecuteScriptSchemaFilter);
      });
