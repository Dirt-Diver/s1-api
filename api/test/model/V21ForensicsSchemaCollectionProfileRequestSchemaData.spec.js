...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ForensicsSchemaCollectionProfileRequestSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ForensicsSchemaCollectionProfileRequestSchemaData();
      });

      it('should create an instance of V21ForensicsSchemaCollectionProfileRequestSchemaData', function() {
        // TODO: update the code to test V21ForensicsSchemaCollectionProfileRequestSchemaData
        expect(instance).to.be.a(S1MgmtApi.V21ForensicsSchemaCollectionProfileRequestSchemaData);
      });
