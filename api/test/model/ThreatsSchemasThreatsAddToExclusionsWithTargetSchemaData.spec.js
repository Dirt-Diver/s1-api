...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatsAddToExclusionsWithTargetSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatsAddToExclusionsWithTargetSchemaData();
      });

      it('should create an instance of ThreatsSchemasThreatsAddToExclusionsWithTargetSchemaData', function() {
        // TODO: update the code to test ThreatsSchemasThreatsAddToExclusionsWithTargetSchemaData
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatsAddToExclusionsWithTargetSchemaData);
      });
