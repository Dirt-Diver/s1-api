...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatsMitigateRequestSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatsMitigateRequestSchemaFilter();
      });

      it('should create an instance of ThreatsSchemasThreatsMitigateRequestSchemaFilter', function() {
        // TODO: update the code to test ThreatsSchemasThreatsMitigateRequestSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatsMitigateRequestSchemaFilter);
      });
