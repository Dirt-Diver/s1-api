...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21MarketplaceSchemaEnableDisableApplicationSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21MarketplaceSchemaEnableDisableApplicationSchemaFilter();
      });

      it('should create an instance of V21MarketplaceSchemaEnableDisableApplicationSchemaFilter', function() {
        // TODO: update the code to test V21MarketplaceSchemaEnableDisableApplicationSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21MarketplaceSchemaEnableDisableApplicationSchemaFilter);
      });
