...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackagesSchemasLatestPackagesSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.PackagesSchemasLatestPackagesSchema200Data();
      });

      it('should create an instance of PackagesSchemasLatestPackagesSchema200Data', function() {
        // TODO: update the code to test PackagesSchemasLatestPackagesSchema200Data
        expect(instance).to.be.a(S1MgmtApi.PackagesSchemasLatestPackagesSchema200Data);
      });
