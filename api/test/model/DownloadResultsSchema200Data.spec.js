...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DownloadResultsSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.DownloadResultsSchema200Data();
      });

      it('should create an instance of DownloadResultsSchema200Data', function() {
        // TODO: update the code to test DownloadResultsSchema200Data
        expect(instance).to.be.a(S1MgmtApi.DownloadResultsSchema200Data);
      });
