...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeviceControlSchemasPostDeviceSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.DeviceControlSchemasPostDeviceSchemaData();
      });

      it('should create an instance of DeviceControlSchemasPostDeviceSchemaData', function() {
        // TODO: update the code to test DeviceControlSchemasPostDeviceSchemaData
        expect(instance).to.be.a(S1MgmtApi.DeviceControlSchemasPostDeviceSchemaData);
      });
