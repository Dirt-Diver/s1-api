...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RangerGatewaySchemaGatewayViewSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.RangerGatewaySchemaGatewayViewSchemaMany200Data();
      });

      it('should create an instance of RangerGatewaySchemaGatewayViewSchemaMany200Data', function() {
        // TODO: update the code to test RangerGatewaySchemaGatewayViewSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.RangerGatewaySchemaGatewayViewSchemaMany200Data);
      });
