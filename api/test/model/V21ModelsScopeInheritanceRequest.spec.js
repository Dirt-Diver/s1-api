...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ModelsScopeInheritanceRequest', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ModelsScopeInheritanceRequest();
      });

      it('should create an instance of V21ModelsScopeInheritanceRequest', function() {
        // TODO: update the code to test V21ModelsScopeInheritanceRequest
        expect(instance).to.be.a(S1MgmtApi.V21ModelsScopeInheritanceRequest);
      });
