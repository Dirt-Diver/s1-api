...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExclusionsSchemasRestrictionSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ExclusionsSchemasRestrictionSchemaMany200Data();
      });

      it('should create an instance of ExclusionsSchemasRestrictionSchemaMany200Data', function() {
        // TODO: update the code to test ExclusionsSchemasRestrictionSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.ExclusionsSchemasRestrictionSchemaMany200Data);
      });
