...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21MarketplaceSchemaApplicationViewSchemaMany200Scopes', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21MarketplaceSchemaApplicationViewSchemaMany200Scopes();
      });

      it('should create an instance of V21MarketplaceSchemaApplicationViewSchemaMany200Scopes', function() {
        // TODO: update the code to test V21MarketplaceSchemaApplicationViewSchemaMany200Scopes
        expect(instance).to.be.a(S1MgmtApi.V21MarketplaceSchemaApplicationViewSchemaMany200Scopes);
      });
