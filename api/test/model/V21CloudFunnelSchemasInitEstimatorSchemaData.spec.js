...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21CloudFunnelSchemasInitEstimatorSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21CloudFunnelSchemasInitEstimatorSchemaData();
      });

      it('should create an instance of V21CloudFunnelSchemasInitEstimatorSchemaData', function() {
        // TODO: update the code to test V21CloudFunnelSchemasInitEstimatorSchemaData
        expect(instance).to.be.a(S1MgmtApi.V21CloudFunnelSchemasInitEstimatorSchemaData);
      });
