...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CloudProxyRemoteScriptsExecuteScriptSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.CloudProxyRemoteScriptsExecuteScriptSchemaData();
      });

      it('should create an instance of CloudProxyRemoteScriptsExecuteScriptSchemaData', function() {
        // TODO: update the code to test CloudProxyRemoteScriptsExecuteScriptSchemaData
        expect(instance).to.be.a(S1MgmtApi.CloudProxyRemoteScriptsExecuteScriptSchemaData);
      });
