...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeviceControlSchemasDeviceSettingsSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.DeviceControlSchemasDeviceSettingsSchema200Data();
      });

      it('should create an instance of DeviceControlSchemasDeviceSettingsSchema200Data', function() {
        // TODO: update the code to test DeviceControlSchemasDeviceSettingsSchema200Data
        expect(instance).to.be.a(S1MgmtApi.DeviceControlSchemasDeviceSettingsSchema200Data);
      });
