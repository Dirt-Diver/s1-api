...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReportsReportTasksPostSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ReportsReportTasksPostSchemaFilter();
      });

      it('should create an instance of ReportsReportTasksPostSchemaFilter', function() {
        // TODO: update the code to test ReportsReportTasksPostSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.ReportsReportTasksPostSchemaFilter);
      });
