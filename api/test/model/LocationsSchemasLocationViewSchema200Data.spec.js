...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationsSchemasLocationViewSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.LocationsSchemasLocationViewSchema200Data();
      });

      it('should create an instance of LocationsSchemasLocationViewSchema200Data', function() {
        // TODO: update the code to test LocationsSchemasLocationViewSchema200Data
        expect(instance).to.be.a(S1MgmtApi.LocationsSchemasLocationViewSchema200Data);
      });
