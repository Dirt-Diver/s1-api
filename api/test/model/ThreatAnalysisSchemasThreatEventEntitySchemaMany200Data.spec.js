...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatAnalysisSchemasThreatEventEntitySchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatAnalysisSchemasThreatEventEntitySchemaMany200Data();
      });

      it('should create an instance of ThreatAnalysisSchemasThreatEventEntitySchemaMany200Data', function() {
        // TODO: update the code to test ThreatAnalysisSchemasThreatEventEntitySchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.ThreatAnalysisSchemasThreatEventEntitySchemaMany200Data);
      });

      it('should have the property activeContentHash (base name: "activeContentHash")', function() {
        // TODO: update the code to test the property activeContentHash
        expect(instance).to.have.property('activeContentHash');
        // expect(instance.activeContentHash).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property activeContentFileId (base name: "activeContentFileId")', function() {
        // TODO: update the code to test the property activeContentFileId
        expect(instance).to.have.property('activeContentFileId');
        // expect(instance.activeContentFileId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property activeContentPath (base name: "activeContentPath")', function() {
        // TODO: update the code to test the property activeContentPath
        expect(instance).to.have.property('activeContentPath');
        // expect(instance.activeContentPath).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property hasActiveContent (base name: "hasActiveContent")', function() {
        // TODO: update the code to test the property hasActiveContent
        expect(instance).to.have.property('hasActiveContent');
        // expect(instance.hasActiveContent).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property registryClassification (base name: "registryClassification")', function() {
        // TODO: update the code to test the property registryClassification
        expect(instance).to.have.property('registryClassification');
        // expect(instance.registryClassification).to.be(expectedValueLiteral);
      });
