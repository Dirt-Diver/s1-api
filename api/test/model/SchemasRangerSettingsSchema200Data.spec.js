...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SchemasRangerSettingsSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SchemasRangerSettingsSchema200Data();
      });

      it('should create an instance of SchemasRangerSettingsSchema200Data', function() {
        // TODO: update the code to test SchemasRangerSettingsSchema200Data
        expect(instance).to.be.a(S1MgmtApi.SchemasRangerSettingsSchema200Data);
      });
