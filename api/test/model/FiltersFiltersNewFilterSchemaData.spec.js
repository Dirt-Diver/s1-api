...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FiltersFiltersNewFilterSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FiltersFiltersNewFilterSchemaData();
      });

      it('should create an instance of FiltersFiltersNewFilterSchemaData', function() {
        // TODO: update the code to test FiltersFiltersNewFilterSchemaData
        expect(instance).to.be.a(S1MgmtApi.FiltersFiltersNewFilterSchemaData);
      });
