...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SettingsSyslogSettingsPutSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SettingsSyslogSettingsPutSchemaData();
      });

      it('should create an instance of SettingsSyslogSettingsPutSchemaData', function() {
        // TODO: update the code to test SettingsSyslogSettingsPutSchemaData
        expect(instance).to.be.a(S1MgmtApi.SettingsSyslogSettingsPutSchemaData);
      });
