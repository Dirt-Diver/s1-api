...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersSchemasCreateUserSchemaDataSiteRoles', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.UsersSchemasCreateUserSchemaDataSiteRoles();
      });

      it('should create an instance of UsersSchemasCreateUserSchemaDataSiteRoles', function() {
        // TODO: update the code to test UsersSchemasCreateUserSchemaDataSiteRoles
        expect(instance).to.be.a(S1MgmtApi.UsersSchemasCreateUserSchemaDataSiteRoles);
      });
