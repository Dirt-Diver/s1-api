...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21DevicesSchemasDeviceDataSchemaMany200ThreatCounts', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21DevicesSchemasDeviceDataSchemaMany200ThreatCounts();
      });

      it('should create an instance of V21DevicesSchemasDeviceDataSchemaMany200ThreatCounts', function() {
        // TODO: update the code to test V21DevicesSchemasDeviceDataSchemaMany200ThreatCounts
        expect(instance).to.be.a(S1MgmtApi.V21DevicesSchemasDeviceDataSchemaMany200ThreatCounts);
      });
