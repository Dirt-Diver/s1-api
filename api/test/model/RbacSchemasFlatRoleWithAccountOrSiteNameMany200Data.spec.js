...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RbacSchemasFlatRoleWithAccountOrSiteNameMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.RbacSchemasFlatRoleWithAccountOrSiteNameMany200Data();
      });

      it('should create an instance of RbacSchemasFlatRoleWithAccountOrSiteNameMany200Data', function() {
        // TODO: update the code to test RbacSchemasFlatRoleWithAccountOrSiteNameMany200Data
        expect(instance).to.be.a(S1MgmtApi.RbacSchemasFlatRoleWithAccountOrSiteNameMany200Data);
      });
