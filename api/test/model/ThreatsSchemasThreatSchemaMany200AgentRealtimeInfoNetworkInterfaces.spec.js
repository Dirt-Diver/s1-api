...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatSchemaMany200AgentRealtimeInfoNetworkInterfaces', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatSchemaMany200AgentRealtimeInfoNetworkInterfaces();
      });

      it('should create an instance of ThreatsSchemasThreatSchemaMany200AgentRealtimeInfoNetworkInterfaces', function() {
        // TODO: update the code to test ThreatsSchemasThreatSchemaMany200AgentRealtimeInfoNetworkInterfaces
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatSchemaMany200AgentRealtimeInfoNetworkInterfaces);
      });
