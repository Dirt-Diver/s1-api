...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AgentsSchemasAgentsDangerousActionSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.AgentsSchemasAgentsDangerousActionSchemaFilter();
      });

      it('should create an instance of AgentsSchemasAgentsDangerousActionSchemaFilter', function() {
        // TODO: update the code to test AgentsSchemasAgentsDangerousActionSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.AgentsSchemasAgentsDangerousActionSchemaFilter);
      });
