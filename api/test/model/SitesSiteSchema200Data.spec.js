...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesSiteSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesSiteSchema200Data();
      });

      it('should create an instance of SitesSiteSchema200Data', function() {
        // TODO: update the code to test SitesSiteSchema200Data
        expect(instance).to.be.a(S1MgmtApi.SitesSiteSchema200Data);
      });
