...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceUsersSchemasGetServiceUserSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ServiceUsersSchemasGetServiceUserSchema200Data();
      });

      it('should create an instance of ServiceUsersSchemasGetServiceUserSchema200Data', function() {
        // TODO: update the code to test ServiceUsersSchemasGetServiceUserSchema200Data
        expect(instance).to.be.a(S1MgmtApi.ServiceUsersSchemasGetServiceUserSchema200Data);
      });
