...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThreatsSchemasThreatsIncidentResultSchema200DataDetails', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ThreatsSchemasThreatsIncidentResultSchema200DataDetails();
      });

      it('should create an instance of ThreatsSchemasThreatsIncidentResultSchema200DataDetails', function() {
        // TODO: update the code to test ThreatsSchemasThreatsIncidentResultSchema200DataDetails
        expect(instance).to.be.a(S1MgmtApi.ThreatsSchemasThreatsIncidentResultSchema200DataDetails);
      });
