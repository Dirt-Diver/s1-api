...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExclusionsSchemasPostExclusionSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ExclusionsSchemasPostExclusionSchemaFilter();
      });

      it('should create an instance of ExclusionsSchemasPostExclusionSchemaFilter', function() {
        // TODO: update the code to test ExclusionsSchemasPostExclusionSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.ExclusionsSchemasPostExclusionSchemaFilter);
      });
