...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21IncidentsSchemasUpdateAnalystVerdictRequestSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21IncidentsSchemasUpdateAnalystVerdictRequestSchemaFilter();
      });

      it('should create an instance of V21IncidentsSchemasUpdateAnalystVerdictRequestSchemaFilter', function() {
        // TODO: update the code to test V21IncidentsSchemasUpdateAnalystVerdictRequestSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.V21IncidentsSchemasUpdateAnalystVerdictRequestSchemaFilter);
      });
