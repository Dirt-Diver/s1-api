...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountsSchemasPostAccountSchemaDataLicensesSettings', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.AccountsSchemasPostAccountSchemaDataLicensesSettings();
      });

      it('should create an instance of AccountsSchemasPostAccountSchemaDataLicensesSettings', function() {
        // TODO: update the code to test AccountsSchemasPostAccountSchemaDataLicensesSettings
        expect(instance).to.be.a(S1MgmtApi.AccountsSchemasPostAccountSchemaDataLicensesSettings);
      });
