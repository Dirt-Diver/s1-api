...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AgentsSchemasAgentsUpdateExternalIdSchemeFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.AgentsSchemasAgentsUpdateExternalIdSchemeFilter();
      });

      it('should create an instance of AgentsSchemasAgentsUpdateExternalIdSchemeFilter', function() {
        // TODO: update the code to test AgentsSchemasAgentsUpdateExternalIdSchemeFilter
        expect(instance).to.be.a(S1MgmtApi.AgentsSchemasAgentsUpdateExternalIdSchemeFilter);
      });
