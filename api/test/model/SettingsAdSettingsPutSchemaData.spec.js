...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SettingsAdSettingsPutSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SettingsAdSettingsPutSchemaData();
      });

      it('should create an instance of SettingsAdSettingsPutSchemaData', function() {
        // TODO: update the code to test SettingsAdSettingsPutSchemaData
        expect(instance).to.be.a(S1MgmtApi.SettingsAdSettingsPutSchemaData);
      });
