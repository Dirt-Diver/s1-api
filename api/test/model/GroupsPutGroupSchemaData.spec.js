...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsPutGroupSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.GroupsPutGroupSchemaData();
      });

      it('should create an instance of GroupsPutGroupSchemaData', function() {
        // TODO: update the code to test GroupsPutGroupSchemaData
        expect(instance).to.be.a(S1MgmtApi.GroupsPutGroupSchemaData);
      });
