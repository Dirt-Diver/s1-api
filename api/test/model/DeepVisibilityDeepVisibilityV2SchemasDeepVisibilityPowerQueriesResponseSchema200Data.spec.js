...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityPowerQueriesResponseSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityPowerQueriesResponseSchema200Data();
      });

      it('should create an instance of DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityPowerQueriesResponseSchema200Data', function() {
        // TODO: update the code to test DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityPowerQueriesResponseSchema200Data
        expect(instance).to.be.a(S1MgmtApi.DeepVisibilityDeepVisibilityV2SchemasDeepVisibilityPowerQueriesResponseSchema200Data);
      });
