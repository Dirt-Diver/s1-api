...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FiltersFiltersUpdateFilterSchemaDataFilterFields', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FiltersFiltersUpdateFilterSchemaDataFilterFields();
      });

      it('should create an instance of FiltersFiltersUpdateFilterSchemaDataFilterFields', function() {
        // TODO: update the code to test FiltersFiltersUpdateFilterSchemaDataFilterFields
        expect(instance).to.be.a(S1MgmtApi.FiltersFiltersUpdateFilterSchemaDataFilterFields);
      });
