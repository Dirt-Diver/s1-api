...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SitesSiteWithUserSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SitesSiteWithUserSchema200Data();
      });

      it('should create an instance of SitesSiteWithUserSchema200Data', function() {
        // TODO: update the code to test SitesSiteWithUserSchema200Data
        expect(instance).to.be.a(S1MgmtApi.SitesSiteWithUserSchema200Data);
      });
