...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceUsersSchemasBulkDeleteServiceUsersSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ServiceUsersSchemasBulkDeleteServiceUsersSchemaFilter();
      });

      it('should create an instance of ServiceUsersSchemasBulkDeleteServiceUsersSchemaFilter', function() {
        // TODO: update the code to test ServiceUsersSchemasBulkDeleteServiceUsersSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.ServiceUsersSchemasBulkDeleteServiceUsersSchemaFilter);
      });
