...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FirewallControlSchemasReorderSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.FirewallControlSchemasReorderSchemaFilter();
      });

      it('should create an instance of FirewallControlSchemasReorderSchemaFilter', function() {
        // TODO: update the code to test FirewallControlSchemasReorderSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.FirewallControlSchemasReorderSchemaFilter);
      });
