...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountsSchemasAccountViewSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.AccountsSchemasAccountViewSchema200Data();
      });

      it('should create an instance of AccountsSchemasAccountViewSchema200Data', function() {
        // TODO: update the code to test AccountsSchemasAccountViewSchema200Data
        expect(instance).to.be.a(S1MgmtApi.AccountsSchemasAccountViewSchema200Data);
      });
