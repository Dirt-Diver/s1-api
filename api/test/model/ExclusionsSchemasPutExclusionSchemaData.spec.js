...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExclusionsSchemasPutExclusionSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.ExclusionsSchemasPutExclusionSchemaData();
      });

      it('should create an instance of ExclusionsSchemasPutExclusionSchemaData', function() {
        // TODO: update the code to test ExclusionsSchemasPutExclusionSchemaData
        expect(instance).to.be.a(S1MgmtApi.ExclusionsSchemasPutExclusionSchemaData);
      });
