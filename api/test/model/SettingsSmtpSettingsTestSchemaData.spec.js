...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SettingsSmtpSettingsTestSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SettingsSmtpSettingsTestSchemaData();
      });

      it('should create an instance of SettingsSmtpSettingsTestSchemaData', function() {
        // TODO: update the code to test SettingsSmtpSettingsTestSchemaData
        expect(instance).to.be.a(S1MgmtApi.SettingsSmtpSettingsTestSchemaData);
      });
