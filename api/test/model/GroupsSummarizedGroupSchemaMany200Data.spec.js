...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsSummarizedGroupSchemaMany200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.GroupsSummarizedGroupSchemaMany200Data();
      });

      it('should create an instance of GroupsSummarizedGroupSchemaMany200Data', function() {
        // TODO: update the code to test GroupsSummarizedGroupSchemaMany200Data
        expect(instance).to.be.a(S1MgmtApi.GroupsSummarizedGroupSchemaMany200Data);
      });
