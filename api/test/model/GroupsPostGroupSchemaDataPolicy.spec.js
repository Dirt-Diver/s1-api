...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupsPostGroupSchemaDataPolicy', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.GroupsPostGroupSchemaDataPolicy();
      });

      it('should create an instance of GroupsPostGroupSchemaDataPolicy', function() {
        // TODO: update the code to test GroupsPostGroupSchemaDataPolicy
        expect(instance).to.be.a(S1MgmtApi.GroupsPostGroupSchemaDataPolicy);
      });
