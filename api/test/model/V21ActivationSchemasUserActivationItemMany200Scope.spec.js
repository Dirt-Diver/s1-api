...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21ActivationSchemasUserActivationItemMany200Scope', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21ActivationSchemasUserActivationItemMany200Scope();
      });

      it('should create an instance of V21ActivationSchemasUserActivationItemMany200Scope', function() {
        // TODO: update the code to test V21ActivationSchemasUserActivationItemMany200Scope
        expect(instance).to.be.a(S1MgmtApi.V21ActivationSchemasUserActivationItemMany200Scope);
      });
