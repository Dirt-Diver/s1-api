...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationsSchemasNewLocationSchemaFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.LocationsSchemasNewLocationSchemaFilter();
      });

      it('should create an instance of LocationsSchemasNewLocationSchemaFilter', function() {
        // TODO: update the code to test LocationsSchemasNewLocationSchemaFilter
        expect(instance).to.be.a(S1MgmtApi.LocationsSchemasNewLocationSchemaFilter);
      });
