...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemPutSystemConfigurationFilter', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.SystemPutSystemConfigurationFilter();
      });

      it('should create an instance of SystemPutSystemConfigurationFilter', function() {
        // TODO: update the code to test SystemPutSystemConfigurationFilter
        expect(instance).to.be.a(S1MgmtApi.SystemPutSystemConfigurationFilter);
      });
