...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V21SchemasUserConfigFilterSchema', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.V21SchemasUserConfigFilterSchema();
      });

      it('should create an instance of V21SchemasUserConfigFilterSchema', function() {
        // TODO: update the code to test V21SchemasUserConfigFilterSchema
        expect(instance).to.be.a(S1MgmtApi.V21SchemasUserConfigFilterSchema);
      });
