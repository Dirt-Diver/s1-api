...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackagesSchemasVersionUploadSchema200Data', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.PackagesSchemasVersionUploadSchema200Data();
      });

      it('should create an instance of PackagesSchemasVersionUploadSchema200Data', function() {
        // TODO: update the code to test PackagesSchemasVersionUploadSchema200Data
        expect(instance).to.be.a(S1MgmtApi.PackagesSchemasVersionUploadSchema200Data);
      });
