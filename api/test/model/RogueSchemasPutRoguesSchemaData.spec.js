...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RogueSchemasPutRoguesSchemaData', function() {
      beforeEach(function() {
        instance = new S1MgmtApi.RogueSchemasPutRoguesSchemaData();
      });

      it('should create an instance of RogueSchemasPutRoguesSchemaData', function() {
        // TODO: update the code to test RogueSchemasPutRoguesSchemaData
        expect(instance).to.be.a(S1MgmtApi.RogueSchemasPutRoguesSchemaData);
      });
